...
: FLN OVER DUP 7ff00000H AND 0= OVER 0< OR NIP
      ...
      0.6931471805599453 F* CALL
		R1@ 20 RSHIFT 7FFH =
      IF 1.0 ELSE R1@ R@ R1@ 7ff00000H AND 0 F/ CALL ENDIF A:2DROP ( normalize )
...
:LOCAL STOREDIGIT 9 >! NIP IF BUILD> [CHAR] a 10 - DOES> ELSE ABS [CHAR] 0 ENDIF + APPENDDIGIT CALL ;
