# 
# Project automation script for FORTHSPMD 
# 
# Created for ISE version 12.2
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source FORTHSPMD.tcl), then you can
...
set myProject "FORTHSPMD"
set myScript "FORTHSPMD.tcl"
...
proc add_source_files {} {
   ...
   xfile add "ALU.vhd"
   xfile add "FiFo.vhd"
   xfile add "IntVectors.vhd"
   xfile add "MYCPU.ucf"
   xfile add "ProgramCounter.vhd"
   xfile add "ROMcode.vhd"
   xfile add "SIO.fs"
   xfile add "TimerOff.fs"
   xfile add "TimerOn.fs"
   xfile add "UART.vhd"
   xfile add "bios.fs"
   xfile add "buddy.fs"
   xfile add "consoleIn.fs"
   xfile add "consoleOut.fs"
   xfile add "counter.fs"
   xfile add "counter.vhd"
   xfile add "dcm1.vhd"
   xfile add "dictionary.fs"
   xfile add "fifo_generator_v6_1.vhd"
   xfile add "fileIO.fs"
   xfile add "fmath.fs"
   xfile add "formatnumber.fs"
   xfile add "global.vhd"
   xfile add "interruptservice.fs"
   xfile add "java.txt"
   xfile add "linker.fs"
   xfile add "math.fs"
   xfile add "memorymanagement.fs"
   xfile add "mycpu.vhd"
   xfile add "noonthefly.fs"
   xfile add "onthefly.fs"
   xfile add "theCore.vhd"
   xfile add "theStacks.vhd"
   xfile add "vhdl_syn_bl4.vhd"
   xfile add "vhdl_syn_bl4_RAM8D_0.vhd"
   xfile add "vhdl_syn_bl4_RAM8D_1.vhd"
   xfile add "vhdl_syn_bl4_cal_ctl_0.vhd"
   xfile add "vhdl_syn_bl4_cal_top.vhd"
   xfile add "vhdl_syn_bl4_clk_dcm.vhd"
   xfile add "vhdl_syn_bl4_controller_0.vhd"
   xfile add "vhdl_syn_bl4_controller_iobs_0.vhd"
   xfile add "vhdl_syn_bl4_data_path_0.vhd"
   xfile add "vhdl_syn_bl4_data_path_iobs_0.vhd"
   xfile add "vhdl_syn_bl4_data_path_rst.vhd"
   xfile add "vhdl_syn_bl4_data_read_0.vhd"
   xfile add "vhdl_syn_bl4_data_read_controller_0.vhd"
   xfile add "vhdl_syn_bl4_data_write_0.vhd"
   xfile add "vhdl_syn_bl4_ddr2_dm_0.vhd"
   xfile add "vhdl_syn_bl4_dqs_delay_0.vhd"
   xfile add "vhdl_syn_bl4_fifo_0_wr_en_0.vhd"
   xfile add "vhdl_syn_bl4_fifo_1_wr_en_0.vhd"
   xfile add "vhdl_syn_bl4_infrastructure.vhd"
   xfile add "vhdl_syn_bl4_infrastructure_iobs_0.vhd"
   xfile add "vhdl_syn_bl4_infrastructure_top_0.vhd"
   xfile add "vhdl_syn_bl4_iobs_0.vhd"
   xfile add "vhdl_syn_bl4_parameters_0.vhd"
   xfile add "vhdl_syn_bl4_rd_gray_cntr.vhd"
   xfile add "vhdl_syn_bl4_s3_ddr_iob.vhd"
   xfile add "vhdl_syn_bl4_s3_dqs_iob.vhd"
   xfile add "vhdl_syn_bl4_tap_dly_0.vhd"
   xfile add "vhdl_syn_bl4_top_0.vhd"
   xfile add "vhdl_syn_bl4_wr_gray_cntr.vhd"

   # Set the Top Module as well...
   project set top "Rtl" "MYCPU"
...
proc set_process_props {} {
   ...
   project set "DCI Update Mode" "As Required"
   ...
   project set "Load Timing Specification Interaction Report" "false"
   ...
   project set "Implementation Start View" ""
   project set "Implementation Stop View" "AbstractSynthesis"
   ...
   project set "Generate Detailed Package Parasitics" "false"
   ...
   project set "Use DSP48" "Auto"
   project set "Configuration Clk (Configuration Pins)" "Pull Up"
   project set "UserID Code (8 Digit Hexadecimal)" "0xFFFFFFFF" -process "Generate Programming File"
   project set "Reset DCM if SHUTDOWN & AGHIGH performed" "false"
   ...
   project set "Configuration Pin HSWAPEN" "Pull Up"
   project set "Configuration Pin M0" "Pull Up"
   project set "Configuration Pin M1" "Pull Up"
   project set "Configuration Pin M2" "Pull Up"
   ...
   project set "Configuration Pin Powerdown" "Pull Up"
   ...
   project set "Wait for DCI Match (Output Events)" "Auto"
   ...
   project set "Tri-state Buffer Transformation Mode" "Off"
   ...
   project set "Work Directory" "C:/Xilinx/FORTHSPMD/xst" -process "Synthesize - XST"
   project set "Write Timing Constraints" "false" -process "Synthesize - XST"
   project set "Other XST Command Line Options" "" -process "Synthesize - XST"
   project set "Auto Implementation Compile Order" "true"
   project set "Auto Implementation Top" "true"
   project set "Compile SmartModels (PPC, MGT) Simulation Library" "false"
   project set "Update modelsim.ini File for Xilinx SmartModel Use" "false"
   ...
   project set "Encrypt Bitstream" "false"
   project set "Output File Name" "MYCPU" -process "Generate IBIS Model"
   project set "Baud rate" "None"
   ...
   project set "Enable Multi-Threading" "Off"
