...
const char* AwtChoice::GetClassName() {
    return "COMBOBOX";  /* System provided combobox class */
}

LPCWSTR AwtChoice::GetClassNameW() {
    return L"COMBOBOX";  /* System provided combobox class */
}
