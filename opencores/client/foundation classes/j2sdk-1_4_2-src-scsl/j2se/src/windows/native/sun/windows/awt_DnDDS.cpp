...
HRESULT __stdcall AwtDragSource::GetData(FORMATETC __RPC_FAR *pFormatEtc,
	...
	pmedium->pUnkForRelease = (IUnknown *)istream;
...
const UINT AwtDragSource::PROCESS_ID_FORMAT = 
    ::RegisterClipboardFormat("_SUNW_JAVA_AWT_PROCESS_ID");
...
Java_sun_awt_dnd_SunDragSourceContextPeer_setNativeCursor(JNIEnv* env, 
    ...
    ((AwtDragSource*)nativeCtxt)->SetCursor(cursor);
