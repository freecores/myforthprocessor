/*
 * @(#)awt_Clipboard.cpp	1.34 03/01/23
 *
...
/************************************************************************
 * ClipboardTransferable native methods
 */
...
Java_sun_awt_datatransfer_ClipboardTransferable_getClipboardFormats
    (JNIEnv *env, jobject self, jlong clipboardID)
{
    TRY;
...
Java_sun_awt_datatransfer_ClipboardTransferable_getClipboardData
    (JNIEnv *env, jobject self, jlong clipboardID, jlong format)
{
    TRY;
