...
extern jboolean GetFontProp(JNIEnv *env, jobject font, jstring key);
...
public:
    ...
    /* java.lang.Properties props field of sun.awt.PlatformFont */
    static jfieldID propsID;
     ...
     */
    static char *javaString2multibyte(JNIEnv *env, jstring jtr, 
                                      char buffer[], int length);
    static jstring multibyte2javaString(JNIEnv *env, char * str);
