/*
 * @(#)UnixPrintJob.java	1.18 03/01/23
 *
...
public class UnixPrintJob implements CancelablePrintJob {
    ...
    UnixPrintJob(UnixPrintService service) {
	...
	} else if  (flavor.equals(DocFlavor.URL.AUTOSENSE) ||
		    flavor.equals(DocFlavor.URL.POSTSCRIPT)||
		    flavor.equals(DocFlavor.URL.TEXT_PLAIN_HOST) ||
		    flavor.equals(DocFlavor.URL.TEXT_PLAIN_UTF_8) ||
		    flavor.equals(DocFlavor.URL.TEXT_PLAIN_UTF_16) ||
		    flavor.equals(DocFlavor.URL.TEXT_PLAIN_UTF_16BE) ||
		    flavor.equals(DocFlavor.URL.TEXT_PLAIN_UTF_16LE) ||
		    flavor.equals(DocFlavor.URL.TEXT_PLAIN_US_ASCII)) {
	    URL url = (URL)data;
	    try {
