/*
 * @(#)mlib_v_ImageLookUpSIU8S16Func.c	1.10 03/01/23
 *
...
#pragma ident	"@(#)mlib_v_ImageLookUpSIU8S16Func.c	1.7	98/05/12 SMI"

/*
 * $RCSfile: mlib_v_ImageLookUpSIU8S16Func.c,v $
 * $Revision: 4.1 $
 * $Date: 1996/12/11 20:44:09 $
 * $Author: liang $
 */
...
/***************************************************************/
void mlib_v_ImageLookUpSI_U8_S16_2_SrcOff0_D1(mlib_u8  *src,
                                              mlib_s16 *dst,
                                              mlib_s32 xsize,
                                              mlib_f32 *table)
{
...
/***************************************************************/
void mlib_v_ImageLookUpSI_U8_S16_2_DstNonAl_D1(mlib_u8  *src,
                                               mlib_s16 *dst,
                                               mlib_s32 xsize,
                                               mlib_f32 *table)
{
...
/***************************************************************/
void mlib_v_ImageLookUpSI_U8_S16_2_DstA8D1_SMALL(mlib_u8  *src,
                                                 mlib_s16 *dst,
                                                 mlib_s32 xsize,
                                                 mlib_s16 **table)
{
  ...
  mlib_s32 i;                /* loop variable */
  mlib_s16 *tab0 = table[0];
  mlib_s16 *tab1 = table[1];
...
/***************************************************************/
void mlib_v_ImageLookUpSI_U8_S16_2_D1_SMALL(mlib_u8  *src,
                                            mlib_s16 *dst,
                                            mlib_s32 xsize,
                                            mlib_s16 **table)
{
...
void mlib_v_ImageLookUpSI_U8_S16_2(mlib_u8  *src, mlib_s32 slb,
...
#pragma pipeloop(0)
        ...
        if (size > 0) {
          mlib_v_ImageLookUpSI_U8_S16_2_SrcOff0_D1(sp, dp, size, (mlib_f32*)tab);
        }
      } else {
        ...
        if (size > 0) {
          mlib_v_ImageLookUpSI_U8_S16_2_DstNonAl_D1(sp, dp, size, (mlib_f32*)tab);
        }
      }
...
/***************************************************************/
void mlib_v_ImageLookUpSI_U8_S16_3_SrcOff0_D1(mlib_u8  *src,
                                              mlib_s16 *dst,
                                              mlib_s32 xsize,
                                              mlib_d64 *table)
{
...
/***************************************************************/
void mlib_v_ImageLookUpSI_U8_S16_3_SrcOff1_D1(mlib_u8  *src,
                                              mlib_s16 *dst,
                                              mlib_s32 xsize,
                                              mlib_d64 *table)
{
...
/***************************************************************/
void mlib_v_ImageLookUpSI_U8_S16_3_SrcOff2_D1(mlib_u8  *src,
                                              mlib_s16 *dst,
                                              mlib_s32 xsize,
                                              mlib_d64 *table)
{
...
/***************************************************************/
void mlib_v_ImageLookUpSI_U8_S16_3_SrcOff3_D1(mlib_u8  *src,
                                              mlib_s16 *dst,
                                              mlib_s32 xsize,
                                              mlib_d64 *table)
{
...
/***************************************************************/
void mlib_v_ImageLookUpSI_U8_S16_3_D1_SMALL(mlib_u8  *src,
                                            mlib_s16 *dst,
                                            mlib_s32 xsize,
                                            mlib_s16 **table)
{
...
void mlib_v_ImageLookUpSI_U8_S16_3(mlib_u8  *src, mlib_s32 slb,
                                   mlib_s16 *dst, mlib_s32 dlb,
                                   mlib_s32 xsize, mlib_s32 ysize,
                                   mlib_s16 **table)
{
...
#pragma pipeloop(0)
      ...
      if (size > 0) {
        ...
        if (off == 0) {
          mlib_v_ImageLookUpSI_U8_S16_3_SrcOff0_D1(sp, dp, size, (mlib_d64*)tab);
        } else if (off == 1) {
          mlib_v_ImageLookUpSI_U8_S16_3_SrcOff1_D1(sp, dp, size, (mlib_d64*)tab);
        } else if (off == 2) {
          mlib_v_ImageLookUpSI_U8_S16_3_SrcOff2_D1(sp, dp, size, (mlib_d64*)tab);
        } else if (off == 3) {
          mlib_v_ImageLookUpSI_U8_S16_3_SrcOff3_D1(sp, dp, size, (mlib_d64*)tab);
        }
      }
...
/***************************************************************/
void mlib_v_ImageLookUpSI_U8_S16_4_DstA8D1_D1(mlib_u8  *src,
                                              mlib_s16 *dst,
                                              mlib_s32 xsize,
                                              mlib_d64 *table)
{
...
/***************************************************************/
void mlib_v_ImageLookUpSI_U8_S16_4_DstNonAl_D1(mlib_u8  *src,
                                               mlib_s16 *dst,
                                               mlib_s32 xsize,
                                               mlib_d64 *table)
{
...
/***************************************************************/
void mlib_v_ImageLookUpSI_U8_S16_4_DstOff0_D1_SMALL(mlib_u8  *src,
                                                    mlib_s16 *dst,
                                                    mlib_s32 xsize,
                                                    mlib_s16 **table)
{
...
/***************************************************************/
void mlib_v_ImageLookUpSI_U8_S16_4_DstOff1_D1_SMALL(mlib_u8  *src,
                                                    mlib_s16 *dst,
                                                    mlib_s32 xsize,
                                                    mlib_s16 **table)
{
...
/***************************************************************/
void mlib_v_ImageLookUpSI_U8_S16_4_DstOff2_D1_SMALL(mlib_u8  *src,
                                                    mlib_s16 *dst,
                                                    mlib_s32 xsize,
                                                    mlib_s16 **table)
{
...
/***************************************************************/
void mlib_v_ImageLookUpSI_U8_S16_4_DstOff3_D1_SMALL(mlib_u8  *src,
                                                    mlib_s16 *dst,
                                                    mlib_s32 xsize,
                                                    mlib_s16 **table)
{
...
void mlib_v_ImageLookUpSI_U8_S16_4(mlib_u8  *src, mlib_s32 slb,
                                   mlib_s16 *dst, mlib_s32 dlb,
                                   mlib_s32 xsize, mlib_s32 ysize,
                                   mlib_s16 **table)
{
...
#pragma pipeloop(0)
        ...
        if (size > 0) {
          mlib_v_ImageLookUpSI_U8_S16_4_DstA8D1_D1(sp, dp, size, (mlib_d64*)tab);
        }
      } else {
        ...
        if (size > 0) {
          mlib_v_ImageLookUpSI_U8_S16_4_DstNonAl_D1(sp, dp, size, (mlib_d64*)tab);
        }
      }
