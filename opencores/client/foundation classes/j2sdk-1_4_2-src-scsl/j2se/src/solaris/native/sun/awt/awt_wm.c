 ...
 */
static XErrorHandler xerror_saved_handler;

/*
 * A place for error handler to report the error code.
 */
static unsigned char xerror_code;
 ...
 */
static void
awt_wm_setOLDecor(struct FrameData *wdata, int decorations)
{
 ...
 */
static void
awt_wm_setMotifDecor(struct FrameData *wdata, int decorations)
{
    int functions;
...
awt_wm_setShellDecor(struct FrameData *wdata, Boolean resizable)
{
    ...
    awt_wm_setMotifDecor(wdata, decorations);
    awt_wm_setOLDecor(wdata, decorations);
