...
#include "sun_awt_motif_X11CustomCursor.h"
...
/*
 * Class:     sun_awt_motif_X11CustomCursor
 * Method:    cacheInit
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_sun_awt_motif_X11CustomCursor_cacheInit
 ...
 */
JNIEXPORT void JNICALL Java_sun_awt_motif_X11CustomCursor_queryBestCursor
 ...
 * Signature: ([B[BIIII)V
 */
JNIEXPORT void JNICALL Java_sun_awt_motif_X11CustomCursor_createCursor
