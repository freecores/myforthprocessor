/*
 * @(#)awt_TextField.c	1.101 03/01/23
 *
 ...
 */
JNIEXPORT void JNICALL Java_sun_awt_motif_MTextFieldPeer_create
  (JNIEnv *env, jobject this, jobject parent) 
{
    ...
    XtAddCallback(tdata->comp.widget,
                  ...
                  (XtCallbackProc) Text_valueChanged,
                  (XtPointer) globalRef);
