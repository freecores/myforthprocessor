/*
 * @(#)mlib_v_ImageChannelExtract_43.c	1.8 03/01/23
 *
...
#pragma ident  "@(#)mlib_v_ImageChannelExtract_43.c	1.10  99/09/24 SMI"
                                     ...
                                     mlib_s32 dsize)
{
  ...
  mlib_d64  s0, s1, s2, s3, s4;  /* 8-byte source raw data */
