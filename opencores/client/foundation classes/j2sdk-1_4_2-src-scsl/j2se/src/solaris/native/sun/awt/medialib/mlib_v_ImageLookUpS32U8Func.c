/*
 * @(#)mlib_v_ImageLookUpS32U8Func.c	1.8 03/01/23
 *
...
#pragma ident	"@(#)mlib_v_ImageLookUpS32U8Func.c	1.2	98/09/11 SMI"

/*
 * $RCSfile: mlib_v_ImageLookUpS32U8Func.c,v $
 * $Revision: 4.1 $
...
void mlib_v_ImageLookUp_S32_U8_124_D1(mlib_s32 *src,
                                      mlib_u8  *dst,
                                      mlib_s32 xsize,
                                      mlib_u8 *table0,
                                      mlib_u8 *table1,
...
void mlib_v_ImageLookUp_S32_U8_1(mlib_s32 *src, mlib_s32 slb,
                                 ...
                                 mlib_u8  **table)
{
  mlib_s32 *sl;
  mlib_u8  *dl;
  mlib_u8  *tab = &table[0][(mlib_u32)2147483648];
  mlib_s32 j, i;
...
void mlib_v_ImageLookUp_S32_U8_2(mlib_s32 *src, mlib_s32 slb,
                                 mlib_u8  *dst, mlib_s32 dlb,
                                 mlib_s32 xsize, mlib_s32 ysize,
                                 mlib_u8  **table)
{
...
void mlib_v_ImageLookUp_S32_U8_4(mlib_s32 *src, mlib_s32 slb,
                                 mlib_u8  *dst, mlib_s32 dlb,
                                 mlib_s32 xsize, mlib_s32 ysize,
                                 mlib_u8  **table)
{
...
void mlib_v_ImageLookUp_S32_U8_3_D1(mlib_s32 *src,
                                    mlib_u8  *dst,
                                    mlib_s32 xsize,
                                    mlib_u8 *table0,
                                    mlib_u8 *table1,
...
void mlib_v_ImageLookUp_S32_U8_3(mlib_s32 *src, mlib_s32 slb,
                                 mlib_u8  *dst, mlib_s32 dlb,
                                 mlib_s32 xsize, mlib_s32 ysize,
                                 mlib_u8  **table)
{
