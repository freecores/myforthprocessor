...
JNIEXPORT void JNICALL 
Java_sun_awt_motif_MRobotPeer_mouseMoveImpl(JNIEnv *env,
					jclass class,
...
JNIEXPORT void JNICALL
Java_sun_awt_motif_MRobotPeer_mousePressImpl(JNIEnv *env,
					jclass class,
					jint buttonMask) {
    RCmdButton cmd;
...
JNIEXPORT void JNICALL
Java_sun_awt_motif_MRobotPeer_mouseReleaseImpl(JNIEnv *env,
					     jclass class,
					     jint buttonMask) {
    RCmdButton cmd;
...
JNIEXPORT void JNICALL
Java_sun_awt_motif_MRobotPeer_mouseWheelImpl(JNIEnv *env,
					     jclass class,
					     jint wheelAmt) {
    RCmdWheel cmd;
