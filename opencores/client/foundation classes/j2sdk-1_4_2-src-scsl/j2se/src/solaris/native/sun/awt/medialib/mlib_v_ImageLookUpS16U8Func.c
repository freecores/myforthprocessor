/*
 * @(#)mlib_v_ImageLookUpS16U8Func.c	1.10 03/01/23
 *
...
#pragma ident	"@(#)mlib_v_ImageLookUpS16U8Func.c	1.7	98/05/05 SMI"

/*
 * $RCSfile: mlib_v_ImageLookUpS16U8Func.c,v $
 * $Revision: 4.1 $
 * $Date: 1996/12/11 20:44:03 $
 * $Author: liang $
 */
...
void mlib_v_ImageLookUp_S16_U8_124_D1(mlib_s16 *src,
                                      mlib_u8  *dst,
                                      mlib_s32 xsize,
                                      mlib_u8 *table0,
                                      mlib_u8 *table1,
...
void mlib_v_ImageLookUp_S16_U8_1(mlib_s16 *src, mlib_s32 slb,
...
void mlib_v_ImageLookUp_S16_U8_2(mlib_s16 *src, mlib_s32 slb,
                                 mlib_u8  *dst, mlib_s32 dlb,
                                 mlib_s32 xsize, mlib_s32 ysize,
                                 mlib_u8  **table)
{
...
void mlib_v_ImageLookUp_S16_U8_4(mlib_s16 *src, mlib_s32 slb,
                                 mlib_u8  *dst, mlib_s32 dlb,
                                 mlib_s32 xsize, mlib_s32 ysize,
                                 mlib_u8  **table)
{
...
void mlib_v_ImageLookUp_S16_U8_3_D1(mlib_s16 *src,
                                    mlib_u8  *dst,
                                    mlib_s32 xsize,
                                    mlib_u8 *table0,
                                    mlib_u8 *table1,
...
void mlib_v_ImageLookUp_S16_U8_3(mlib_s16 *src, mlib_s32 slb,
                                 mlib_u8  *dst, mlib_s32 dlb,
                                 mlib_s32 xsize, mlib_s32 ysize,
                                 mlib_u8  **table)
{
