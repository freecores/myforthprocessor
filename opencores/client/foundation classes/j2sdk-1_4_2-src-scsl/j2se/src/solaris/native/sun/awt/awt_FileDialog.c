/*
 * @(#)awt_FileDialog.c	1.76 03/01/23
 *
...
ourSearchProc(Widget w, XtPointer p) {
    ...
    res = JNU_CallMethodByName(env, NULL, this, 
                               "proceedFiltering", "(Ljava/lang/String;Z)Z", 
                               dir_o, awt_currentThreadIsPrivileged(env)).z;
...
#define MAX_ARGC 20
    ...
    argc++;
    XtSetArg(args[argc], XmNfileSearchProc, ourSearchProc);
    argc++;
