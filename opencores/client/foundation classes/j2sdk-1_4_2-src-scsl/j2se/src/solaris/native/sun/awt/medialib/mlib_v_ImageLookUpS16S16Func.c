/*
 * @(#)mlib_v_ImageLookUpS16S16Func.c	1.10 03/01/23
 *
...
#pragma ident	"@(#)mlib_v_ImageLookUpS16S16Func.c	1.8	99/09/06 SMI"

/*
 * $RCSfile: mlib_v_ImageLookUpS16S16Func.c,v $
 * $Revision: 4.1 $
...
void mlib_v_ImageLookUp_S16_S16_124_D1(mlib_s16 *src,
                                       mlib_s16 *dst,
                                       mlib_s32 xsize,
                                       mlib_s16 *table0,
                                       mlib_s16 *table1,
...
void mlib_v_ImageLookUp_S16_S16_1(mlib_s16 *src, mlib_s32 slb,
...
void mlib_v_ImageLookUp_S16_S16_2(mlib_s16 *src, mlib_s32 slb,
                                  mlib_s16 *dst, mlib_s32 dlb,
                                  mlib_s32 xsize, mlib_s32 ysize,
                                  mlib_s16 **table)
{
...
void mlib_v_ImageLookUp_S16_S16_3_D1(mlib_s16  *src,
                                     mlib_s16 *dst,
                                     mlib_s32 xsize,
                                     mlib_s16 *table0,
                                     mlib_s16 *table1,
...
void mlib_v_ImageLookUp_S16_S16_3(mlib_s16 *src, mlib_s32 slb,
                                  mlib_s16 *dst, mlib_s32 dlb,
                                  mlib_s32 xsize, mlib_s32 ysize,
                                  mlib_s16 **table)
{
