/*
 * @(#)mlib_v_ImageLookUpU8S32Func.c	1.8 03/01/23
 *
...
#pragma ident	"@(#)mlib_v_ImageLookUpU8S32Func.c	1.1	98/07/28 SMI"

/*
 * $RCSfile: mlib_v_ImageLookUpU8S32Func.c,v $
 * $Revision: 4.1 $
...
void mlib_v_ImageLookUp_U8_S32_124_D1(mlib_u8  *src,
                                      mlib_f32 *dst,
                                      mlib_s32 xsize,
                                      mlib_f32 *table0,
                                      mlib_f32 *table1,
...
void mlib_v_ImageLookUp_U8_S32_1(mlib_u8  *src, mlib_s32 slb,
...
void mlib_v_ImageLookUp_U8_S32_2(mlib_u8  *src, mlib_s32 slb,
                                 mlib_s32 *dst, mlib_s32 dlb,
                                 mlib_s32 xsize, mlib_s32 ysize,
                                 mlib_s32 **table)
{
...
void mlib_v_ImageLookUp_U8_S32_4(mlib_u8  *src, mlib_s32 slb,
                                 mlib_s32 *dst, mlib_s32 dlb,
                                 mlib_s32 xsize, mlib_s32 ysize,
                                 mlib_s32 **table)
{
...
void mlib_v_ImageLookUp_U8_S32_3_D1(mlib_u8  *src,
                                    mlib_f32 *dst,
                                    mlib_s32 xsize,
                                    mlib_f32 *table0,
                                    mlib_f32 *table1,
...
void mlib_v_ImageLookUp_U8_S32_3(mlib_u8  *src, mlib_s32 slb,
                                 mlib_s32 *dst, mlib_s32 dlb,
                                 mlib_s32 xsize, mlib_s32 ysize,
                                 mlib_s32 **table)
{
