/*
 * @(#)mlib_v_ImageLookUpS32S16Func.c	1.8 03/01/23
 *
...
#pragma ident	"@(#)mlib_v_ImageLookUpS32S16Func.c	1.4	99/09/06 SMI"

/*
 * $RCSfile: mlib_v_ImageLookUpS32S16Func.c,v $
 * $Revision: 4.1 $
 * $Date: 1996/12/11 20:43:57 $
 * $Author: liang $
 */
...
void mlib_v_ImageLookUp_S32_S16_124_D1(mlib_s32 *src,
                                       mlib_s16 *dst,
                                       mlib_s32 xsize,
                                       mlib_s16 *table0,
                                       mlib_s16 *table1,
...
void mlib_v_ImageLookUp_S32_S16_1(mlib_s32 *src, mlib_s32 slb,
                                  ...
                                  mlib_s16 **table)
{
  mlib_s32 *sl;
  mlib_s16 *dl;
  mlib_s16 *tab = &table[0][(mlib_u32)2147483648];
  mlib_s32 j, i;
...
void mlib_v_ImageLookUp_S32_S16_2(mlib_s32 *src, mlib_s32 slb,
                                  mlib_s16 *dst, mlib_s32 dlb,
                                  mlib_s32 xsize, mlib_s32 ysize,
                                  mlib_s16 **table)
{
...
void mlib_v_ImageLookUp_S32_S16_4(mlib_s32 *src, mlib_s32 slb,
                                  mlib_s16 *dst, mlib_s32 dlb,
                                  mlib_s32 xsize, mlib_s32 ysize,
                                  mlib_s16 **table)
{
...
void mlib_v_ImageLookUp_S32_S16_3(mlib_s32 *src, mlib_s32 slb,
                                  mlib_s16 *dst, mlib_s32 dlb,
                                  mlib_s32 xsize, mlib_s32 ysize,
                                  mlib_s16 **table)
{
