/*
 * @(#)mlib_v_ImageChannelInsert_1.c	1.8 03/01/23
 *
...
#pragma ident	"@(#)mlib_v_ImageChannelInsert_1.c	1.12	99/09/24 SMI"

/*
 * FILENAME: mlib_v_ImageChannelInsert_1.c
 *
 * FUNCTIONS
                        				   ...
                        				   mlib_s32 cmask)
{
  ...
  int       off;		/* offset of src over dst */
  int       emask;		/* edge mask */
				                           ...
				                           mlib_s32 cmask)
{
  ...
  int off;         	/* offset of address alignment in src */
  int	    i;
...
#pragma pipeloop(0)
  ...
  if ((mlib_addr) da <= (mlib_addr) dend) {
    ...
    vis_alignaddr((void *)0, 1);
    vis_st_u8(sd = vis_faligndata(sd, sd), da); da += 3;
    if ((mlib_addr) da <= (mlib_addr) dend) {
      vis_st_u8(sd = vis_faligndata(sd, sd), da); da += 3;
      if ((mlib_addr) da <= (mlib_addr) dend) {
        vis_st_u8(sd = vis_faligndata(sd, sd), da); da += 3;
...
#pragma pipeloop(0)
  ...
  if ((mlib_addr) da <= (mlib_addr) dend) {
    ...
    vis_alignaddr((void *)0, 2);
    vis_st_u16(sd = vis_faligndata(sd, sd), da); da += 2;
    if ((mlib_addr) da <= (mlib_addr) dend) {
      vis_st_u16(sd = vis_faligndata(sd, sd), da); da += 2;
      if ((mlib_addr) da <= (mlib_addr) dend) {
...
#pragma pipeloop(0)
  ...
  if ((mlib_addr) da <= (mlib_addr) dend) {
    ...
    vis_alignaddr((void *)0, 2);
    vis_st_u16(sd = vis_faligndata(sd, sd), da); da += 3;
    if ((mlib_addr) da <= (mlib_addr) dend) {
      vis_st_u16(sd = vis_faligndata(sd, sd), da); da += 3;
      if ((mlib_addr) da <= (mlib_addr) dend) {
        vis_st_u16(sd = vis_faligndata(sd, sd), da);
...
#pragma pipeloop(0)
  ...
  if ((mlib_addr) da <= (mlib_addr) dend) {
    ...
    vis_alignaddr((void *)0, 2);
    vis_st_u16(sd = vis_faligndata(sd, sd), da); da += 4;
    if ((mlib_addr) da <= (mlib_addr) dend) {
      vis_st_u16(sd = vis_faligndata(sd, sd), da); da += 4;
      if ((mlib_addr) da <= (mlib_addr) dend) {
        vis_st_u16(sd = vis_faligndata(sd, sd), da);
