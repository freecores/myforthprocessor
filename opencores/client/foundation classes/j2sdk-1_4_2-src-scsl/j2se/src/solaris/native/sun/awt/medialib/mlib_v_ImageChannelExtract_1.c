/*
 * @(#)mlib_v_ImageChannelExtract_1.c	1.8 03/01/23
 *
...
#pragma ident	"@(#)mlib_v_ImageChannelExtract_1.c	1.11	99/09/24 SMI"
                                    ...
                                    mlib_s32 cmask)
{
  ...
  if (((cmask == 2) && (soff % 2 == 0)) ||
      ((cmask == 1) && (soff % 2 != 0))) {  /* extract even bytes */
                                     ...
                                     mlib_s32 cmask)
{
  ...
  int soff;    /* offset of address in src */
  int doff;    /* offset of address in dst */
  int off;    /* offset of dst over src */
  int      emask;    /* edge mask */
  int     i, n;
  ...
  if (((cmask == 2) && (soff % 4 == 0)) ||
      ((cmask == 1) && (soff % 4 != 0))) {  /* extract even words */
