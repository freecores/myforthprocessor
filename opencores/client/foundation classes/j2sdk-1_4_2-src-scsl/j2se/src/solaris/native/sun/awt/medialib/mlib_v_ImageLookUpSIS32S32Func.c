/*
 * @(#)mlib_v_ImageLookUpSIS32S32Func.c	1.8 03/01/23
 *
...
#pragma ident	"@(#)mlib_v_ImageLookUpSIS32S32Func.c	1.2	98/09/11 SMI"

/*
 * $RCSfile: mlib_v_ImageLookUpS32S32Func.c,v $
 * $Revision: 4.1 $
...
void mlib_v_ImageLookUpSI_S32_S32(mlib_s32 *src, mlib_s32 slb,
