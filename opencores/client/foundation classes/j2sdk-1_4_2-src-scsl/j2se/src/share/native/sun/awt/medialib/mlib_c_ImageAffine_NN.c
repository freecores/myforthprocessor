/*
 * @(#)mlib_c_ImageAffine_NN.c	1.13 03/01/23
 *
...
#ifdef __SUNPRO_C
#pragma ident  "@(#)mlib_c_ImageAffine_NN.c	1.8  99/03/26 SMI"
#endif /* __SUNPRO_C */

/*
 * FUNCTION
 *      mlib_c_ImageAffine_u8_1ch_nn
 *      mlib_c_ImageAffine_u8_2ch_nn
 *      mlib_c_ImageAffine_u8_3ch_nn
 *      mlib_c_ImageAffine_u8_4ch_nn
 *      mlib_c_ImageAffine_s16_1ch_nn
 *      mlib_c_ImageAffine_s16_2ch_nn
 *      mlib_c_ImageAffine_s16_3ch_nn
 *      mlib_c_ImageAffine_s16_4ch_nn
 ...
 * SYNOPSIS
 *      void mlib_c_ImageAffine_[u8|s16|s32]_?ch_nn
 *                                  (mlib_s32 *leftEdges,
 *                                   mlib_s32 *rightEdges,
 *                                   mlib_s32 *xStarts,
 *                                   mlib_s32 *yStarts,
...
void mlib_c_ImageAffine_u8_1ch_nn(MLIB_AFFINEDEFPARAM);
void mlib_c_ImageAffine_u8_2ch_nn(MLIB_AFFINEDEFPARAM);
void mlib_c_ImageAffine_u8_3ch_nn(MLIB_AFFINEDEFPARAM);
void mlib_c_ImageAffine_u8_4ch_nn(MLIB_AFFINEDEFPARAM);
void mlib_c_ImageAffine_s16_1ch_nn(MLIB_AFFINEDEFPARAM);
void mlib_c_ImageAffine_s16_2ch_nn(MLIB_AFFINEDEFPARAM);
void mlib_c_ImageAffine_s16_3ch_nn(MLIB_AFFINEDEFPARAM);
void mlib_c_ImageAffine_s16_4ch_nn(MLIB_AFFINEDEFPARAM);
...
void mlib_c_ImageAffine_u8_2ch_nn(MLIB_AFFINEDEFPARAM)
{
  ...
  ptrdiff_t srcYStride = lineAddr[1] - srcData;
  if ((((mlib_addr)srcData | (mlib_addr) dstData |
       srcYStride | dstYStride) & 1) == 0) {
    mlib_c_ImageAffine_s16_1ch_nn(MLIB_AFFINECALLPARAM);
    return;
  }
...
void mlib_c_ImageAffine_u8_4ch_nn(MLIB_AFFINEDEFPARAM)
{
  ...
  if ((((mlib_addr)srcData | (mlib_addr) dstData |
       srcYStride | dstYStride) & 1) == 0) {
    mlib_c_ImageAffine_s16_2ch_nn(MLIB_AFFINECALLPARAM);
    return;
  }
