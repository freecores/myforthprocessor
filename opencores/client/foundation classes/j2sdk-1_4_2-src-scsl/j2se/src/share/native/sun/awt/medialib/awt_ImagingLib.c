/*
 * @(#)awt_ImagingLib.c	1.75 03/01/23
 *
...
static mlibFnS_t sMlibFns[] = {
    {mlib_ImageConvMxN,      "mlib_ImageConvMxN"},
    {mlib_ImageAffine,       "mlib_ImageAffine"},
    {mlib_ImageLookUp,       "mlib_ImageLookUp"},
    {mlib_ImageConvKernelConvert, "mlib_ImageConvKernelConvert"},
    {NULL, NULL},
};
