...
{
	KpInt32_t	ThisRead;		/* number of bytes read in last read */
	UINT		BytesRead;
	UINT		BytesToRead;
	KpChar_p	Ptr;
...
KpInt32_t FAR KpFileWrite (
			...
			KpInt32_t		numBytes)
{
	KpInt32_t	ThisWrite;		/* number of bytes written in last write */
	KpChar_p	Ptr;
