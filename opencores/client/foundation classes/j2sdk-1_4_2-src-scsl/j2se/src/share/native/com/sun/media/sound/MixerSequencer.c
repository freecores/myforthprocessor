/*
 * @(#)MixerSequencer.c	1.24 03/01/23
 *
...
JNIEXPORT jlong JNICALL
    Java_com_sun_media_sound_MixerSequencer_nOpenMidiSequencer(JNIEnv* e, jobject thisObj, jbyteArray midiData, jint length)
{
    ...
    // create the song
    xSong = XNewSongPtr(SONG_TYPE_SMS, (short)id,
			(short)midiVoices,
			(short)volumeDivisor,
			(short)channelVoices,
			reverbMode);
    ...
    pSong = GM_LoadSong((void *)e, (void *)globalSequencerObj, (short)id, (void*)xSong,
			pData, 
			(INT32)length,
			NULL,       // no callback
    ...
    */
    ...
    TRACE0("Java_com_sun_media_sound_MixerSequencer_nOpenMidiSequencer completed.\n");
    ...
    Java_com_sun_media_sound_MixerSequencer_nStartSequencer(JNIEnv* e, jobject thisObj, jlong id)
{
    ...
    TRACE0("Java_com_sun_media_sound_MixerSequencer_nStartSequencer.\n");
    VTRACE1("-> id: %lu\n", id);
...
JNIEXPORT void JNICALL
    Java_com_sun_media_sound_MixerSequencer_nPauseSequencer(JNIEnv* e, jobject thisObj, jlong id) 
{

    GM_Song			*pSong = (GM_Song *) (INT_PTR) id;

    TRACE0("Java_com_sun_media_sound_MixerSequencer_nPauseSequencer.\n");
    ...
    Java_com_sun_media_sound_MixerSequencer_nResumeSequencer(JNIEnv* e, jobject thisObj, jlong id) 
{
    ...
    TRACE0("Java_com_sun_media_sound_MixerSequencer_nResumeSequencer.\n");
...
{	
    TRACE0("Java_com_sun_media_sound_MixerSequencer_nGetSequencerTickPosition\n");
    VTRACE1("-> id: %lu\n", id);
...
{	
    TRACE1("Java_com_sun_media_sound_MixerSequencer_nSetSequencerTickPosition: %d.\n", tick);
    VTRACE1("-> id: %lu\n", id);
...
{	
    TRACE0("Java_com_sun_media_sound_MixerSequencer_nGetSequencerMicrosecondPosition\n");
    VTRACE1("-> id: %lu\n", id);
...
{	
    TRACE1("Java_com_sun_media_sound_MixerSequencer_nSetSequencerMicrosecondPosition: %d.\n", microseconds);
    VTRACE1("-> id: %lu\n", id);
