...
public interface Doc extends Comparable {
    ...
    /**
     * Is this Doc item a method (i.e. not a constructor)?  False
     * until overridden.
     *
     * @return true if it represents a method, false if it is anything
     ...
     * class</em></a>?
     * (i.e. not an interface, exception, or error)?
     *
     ...
     * (not an interface)?
     * This includes ordinary classes, errors and exceptions.
     *
     * @return true if it represents a class (not an interface)
     */
    boolean isClass();
