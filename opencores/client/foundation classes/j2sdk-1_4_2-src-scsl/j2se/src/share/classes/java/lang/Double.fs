...
:LOCAL lang.Double.Double§1485259776
   ...
   s
   std18762 VAL
   lang.Double.valueOf§-1535871488 DUP §tempvar V!
   A:R@
   R> -330275840 TRUE ( java.lang.Double.doubleValue§-330275840 ) EXECUTE-METHOD
   lang.Double§-1583528960.table 165889024 EXECUTE-NEW
   DUP §base0 V! TO §this
   FALSE DUP
   IF
      std18762 LABEL TRUE
...
:LOCAL lang.Double.Double§1539458048
   ...
   CELL+ @ OVER
   OVER ! NIP
   lang.Double§-1583528960.table OVER 12 + !
   -1583546368 OVER 20 + !
   " Double " OVER 16 + !
   0 OVER 24 + ! DROP
...
:LOCAL lang.Double.Double§165889024
   1 VALLOCATE LOCAL §base0
   2LOCAL value
   ...
   * @serial
   ...
   \ new statement
   value
   §this CELL+ @ 28 + ( java.lang.Double.value )    2!
...
:LOCAL lang.Double.byteValue§-1994235392
   1 VALLOCATE LOCAL §base0
   ...
   \ new statement
   §this CELL+ @ 28 + ( java.lang.Double.value )    2@ A:R@  F>D NIP 127 U>! NIP
   IF
      0FFFFFF00H OR
   ENDIF
   A:DROP
...
: lang.Double.classMonitorEnter§-433167616
...
: lang.Double.classMonitorLeave§-1691393280
...
: lang.Double.compare§-820026624
   ...
   \ new statement
   d1
   lang.Double.doubleToLongBits§577332224
   TO thisBits
...
:LOCAL lang.Double.compareTo§-879140096
   2 VALLOCATE LOCAL §base0
   ...
   §this A:R@
   o
   R> 1893819136 TRUE ( java.lang.Double.compareTo§1893819136 ) EXECUTE-METHOD
   0 §break18757 BRANCH
...
:LOCAL lang.Double.compareTo§1893819136
   2 VALLOCATE LOCAL §base0
   ...
   \ new statement
   §this CELL+ @ 28 + ( java.lang.Double.value )    2@
   anotherDouble CELL+ @ 28 + ( java.lang.Double.value )    2@
   lang.Double.compare§-820026624
   0 §break18756 BRANCH
...
: lang.Double.doubleToRawLongBits§-243047424
   2LOCAL value
...
:LOCAL lang.Double.doubleValue§-330275840
   1 VALLOCATE LOCAL §base0
   DUP 0 §base0 + V! LOCAL §this
   ...
   \ new statement
   §this CELL+ @ 28 + ( java.lang.Double.value )    2@ A:R@
   A:DROP
   0 §break18749 BRANCH
...
:LOCAL lang.Double.equals§-240098048
   2 VALLOCATE LOCAL §base0
   ...
   obj
   " Double " INSTANCEOF
   and_18850 0BRANCH! DROP
   obj
   CELL+ @ 28 + ( java.lang.Double.value )    2@
   lang.Double.doubleToLongBits§577332224
   §this CELL+ @ 28 + ( java.lang.Double.value )    2@
   lang.Double.doubleToLongBits§577332224
   D=
...
:LOCAL lang.Double.hashCode§-1604556800
   1 VALLOCATE LOCAL §base0
   DUP 0 §base0 + V! LOCAL §this
...
:LOCAL lang.Double.intValue§-370906880
   1 VALLOCATE LOCAL §base0
   DUP 0 §base0 + V! LOCAL §this
   ...
   \ new statement
   §this CELL+ @ 28 + ( java.lang.Double.value )    2@ A:R@  F>D D>S
   A:DROP
   0 §break18747 BRANCH
...
:LOCAL lang.Double.isInfinite§1195337984
   1 VALLOCATE LOCAL §base0
   DUP 0 §base0 + V! LOCAL §this
   ...
   \ new statement
   §this CELL+ @ 28 + ( java.lang.Double.value )    2@
   lang.Double.isInfinite§1623288064
   0 §break18743 BRANCH
...
:LOCAL lang.Double.isNaN§1861708032
   1 VALLOCATE LOCAL §base0
   DUP 0 §base0 + V! LOCAL §this
...
: lang.Double.longBitsToDouble§1340697600
   2LOCAL bits
...
:LOCAL lang.Double.longValue§1506831360
   1 VALLOCATE LOCAL §base0
   DUP 0 §base0 + V! LOCAL §this
   ...
   \ new statement
   §this CELL+ @ 28 + ( java.lang.Double.value )    2@ A:R@  F>D
   A:DROP
   0 §break18748 BRANCH
...
: lang.Double.parseDouble§1159491584
   1 VALLOCATE LOCAL §base0
   LOCAL §exception
...
:LOCAL lang.Double.shortValue§715813632
   1 VALLOCATE LOCAL §base0
   DUP 0 §base0 + V! LOCAL §this
   ...
   \ new statement
   §this CELL+ @ 28 + ( java.lang.Double.value )    2@ A:R@  F>D NIP 32767 U>! NIP
   IF
      0FFFF0000H OR
   ENDIF
   A:DROP
...
:LOCAL lang.Double.toString§1621718016
   1 VALLOCATE LOCAL §base0
   DUP 0 §base0 + V! LOCAL §this
...
: lang.Double.valueOf§-1535871488
   1 VALLOCATE LOCAL §base0
   LOCAL §exception
   DUP 0 §base0 + V! LOCAL s
   ...
   DROP
;
2VARIABLE lang.Double.MAX_VALUE
2VARIABLE lang.Double.MIN_VALUE
2VARIABLE lang.Double.NEGATIVE_INFINITY
2VARIABLE lang.Double.NaN
2VARIABLE lang.Double.POSITIVE_INFINITY
VARIABLE lang.Double._staticBlocking
VARIABLE lang.Double._staticThread
2VARIABLE lang.Double.serialVersionUID

A:HERE VARIABLE lang.Double§-1583528960.table 15 DUP 2* CELLS ALLOT R@ ! A:CELL+
1485259776 R@ ! A:CELL+ lang.Double.Double§1485259776 VAL R@ ! A:CELL+
1539458048 R@ ! A:CELL+ lang.Double.Double§1539458048 VAL R@ ! A:CELL+
165889024 R@ ! A:CELL+ lang.Double.Double§165889024 VAL R@ ! A:CELL+
-1994235392 R@ ! A:CELL+ lang.Double.byteValue§-1994235392 VAL R@ ! A:CELL+
-879140096 R@ ! A:CELL+ lang.Double.compareTo§-879140096 VAL R@ ! A:CELL+
1893819136 R@ ! A:CELL+ lang.Double.compareTo§1893819136 VAL R@ ! A:CELL+
-330275840 R@ ! A:CELL+ lang.Double.doubleValue§-330275840 VAL R@ ! A:CELL+
-240098048 R@ ! A:CELL+ lang.Double.equals§-240098048 VAL R@ ! A:CELL+
-1604556800 R@ ! A:CELL+ lang.Double.hashCode§-1604556800 VAL R@ ! A:CELL+
-370906880 R@ ! A:CELL+ lang.Double.intValue§-370906880 VAL R@ ! A:CELL+
1195337984 R@ ! A:CELL+ lang.Double.isInfinite§1195337984 VAL R@ ! A:CELL+
1861708032 R@ ! A:CELL+ lang.Double.isNaN§1861708032 VAL R@ ! A:CELL+
1506831360 R@ ! A:CELL+ lang.Double.longValue§1506831360 VAL R@ ! A:CELL+
715813632 R@ ! A:CELL+ lang.Double.shortValue§715813632 VAL R@ ! A:CELL+
1621718016 R@ ! A:CELL+ lang.Double.toString§1621718016 VAL R@ ! A:CELL+
A:DROP
