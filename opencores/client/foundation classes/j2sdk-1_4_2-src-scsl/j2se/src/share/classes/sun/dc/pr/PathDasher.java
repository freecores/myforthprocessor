 ...
 * @since   2.0
 */
public class PathDasher implements PathConsumer, DisposerTarget {
...
//  ____________________________________________________________________________
   ...
   /**
    * Dispose the native memory allocated through  cInitialize
    * and set the cData pointer to null.  
    */
    ...
    public PathConsumer getConsumerReferent() {
	return consumer;
    }
