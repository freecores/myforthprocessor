/*
 * @(#)CertPathHelper.java	1.2 03/01/23
 *
...
public abstract class CertPathHelper {
    ...
    protected abstract void implSetPathToNames(X509CertSelector sel, Set names);
    
    protected abstract void implAddIssuer(X509CRLSelector sel, X500Principal name);
    
    protected abstract Collection implGetIssuers(X509CRLSelector sel);
    ...
    static void setPathToNames(X509CertSelector sel, Set names) {
    ...
    static Collection getIssuers(X509CRLSelector sel) {
