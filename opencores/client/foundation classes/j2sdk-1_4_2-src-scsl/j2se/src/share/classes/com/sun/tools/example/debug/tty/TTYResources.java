/*
 * @(#)TTYResources.java	1.10 03/01/23
 *
 ...
 * </ol>
 *
 * @version @(#)TTYResources.java	1.10 03/01/23
 */
public class TTYResources extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = {
        ...
        {"minus version", "This is {0} version {1,date,long} {1,time,long}"},
        ...
        {"Unrecognized command.  Try help...", "Unrecognized command. Try help..."},
