/*
 * @(#)AuthResources_fr.java	1.8 01/12/03
 *
...
public class AuthResources_fr extends java.util.ListResourceBundle {
    ...
    {"Please login to keystore","Connectez-vous au Keystore"},
   ...
   {"Kerberos username [[defUsername]]: ",
    ...
    {"expected keystore type", "type de Keystore pr\u00e9vu"},
    {"can not specify Principal with a ",
        "impossible de sp\u00e9cifier Principal avec une"},
    {"wildcard class without a wildcard name",
        "classe g\u00e9n\u00e9rique sans nom g\u00e9n\u00e9rique"},
    {"expected codeBase or SignedBy", "codeBase ou SignedBy pr\u00e9vu"},
    ...
    {"expected ';', read end of file", "pr\u00e9vu ';', lecture de fin de fichier"},
    {"line ", "ligne "},
    {": expected '", " : pr\u00e9vu '"},
    {"', found '", "', trouv\u00e9 '"},
    {"'", "'"},
