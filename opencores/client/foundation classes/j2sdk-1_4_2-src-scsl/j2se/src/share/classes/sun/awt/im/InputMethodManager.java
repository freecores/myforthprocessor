/*
 * @(#)InputMethodManager.java	1.34 03/01/23
 *
				   ...
				   implements Runnable, ActionListener
{
	...
	selectionMenu = new PopupMenu(selectInputMethodMenuTitle);
	...
	if (hostAdapterLocator != null) {
	    addOneInputMethodToMenu(hostAdapterLocator, currentSelection);
	    ...
	    addOneInputMethodToMenu(locator, currentSelection);
        }

	synchronized (this) {
	    requestComponent.add(selectionMenu);
    ...
    private void addOneInputMethodToMenu(InputMethodLocator locator, String currentSelection) {
        ...
        if (localeCount == 0) {
            ...
            addMenuItem(selectionMenu, label, null, currentSelection);
            ...
            addMenuItem(selectionMenu, label, command, currentSelection);
        } else {
            ...
            for (int j = 0; j < localeCount; j++) {
                ...
                addMenuItem(menu, subLabel, subCommand, currentSelection);
            }
        }
    }

    private MenuItem addMenuItem(Menu targetMenu, String label, String command, String currentSelection) {
        MenuItem menuItem;
     ...
     */
    private static boolean isSelected(String command, String currentSelection) {
    ...
    private void changeInputMethod(String choice) {
