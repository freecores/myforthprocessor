/*
 * @(#)CharToByteEUC_JP_Solaris.java	1.2	03/01/23
...
public class CharToByteEUC_JP_Solaris extends CharToByteJIS0208_Solaris {
    CharToByteJIS0201 cbJIS0201 = new CharToByteJIS0201();
    CharToByteJIS0212_Solaris cbJIS0212 = new CharToByteJIS0212_Solaris();
    CharToByteJIS0212_IBM_Extensions c2bIBM = new CharToByteJIS0212_IBM_Extensions();
    ...
    protected int getNative(char ch) {
        ...
        if (r == 0) {
	    r = c2bIBM.getNative(ch);
            return (r == 0)? r : r + 0x8F8080;
	}
        return r + 0x8F8080;
    }
