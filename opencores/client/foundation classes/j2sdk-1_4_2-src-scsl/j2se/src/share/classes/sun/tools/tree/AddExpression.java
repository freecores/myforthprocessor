/*
 * @(#)AddExpression.java	1.41 03/01/23
 *
...
class AddExpression extends BinaryArithmeticExpression {
     ...
     * -------------
     *
     * A bit of history: this method was added because of the
     * character converter classes in sun.io.  They would often
     * take an obscenely long time to compile.  It became clear
     * that this was because an expression like...
     *
     *     "a" + "b" + "c" + "d"
     *
