...
public class Extern {
    ...
    private String fetchURLComposeExternPackageList(String urlpath,
        ...
        try {
            ...
            return msg().getText("doclet.MalformedURL", link);
        } catch (IOException exc) {
            return msg().getText("doclet.URL_error", link);
        }
        return null;
    }
    ...
    private String readFileComposeExternPackageList(String path,
        ...
        try {
            ...
            if (file.exists() && file.canRead()) {
                ...
                return msg().getText("doclet.File_error", link);
            }
    ...
    public boolean isUrl (String urlCandidate) {
        try {
            URL urlObj = new URL(urlCandidate);
