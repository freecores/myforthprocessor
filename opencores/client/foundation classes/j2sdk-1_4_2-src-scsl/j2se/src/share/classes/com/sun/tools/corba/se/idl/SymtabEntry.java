/*
 * @(#)SymtabEntry.java	1.11 03/01/23
 *
...
public class SymtabEntry
{
  ...
  {
    dynamicVars = new Vector (maxKey + 1);
    for (int i = 0; i <= maxKey; ++i)
      dynamicVars.addElement (null);
  } // initDynamicVars
  ...
  public void dynamicVariable (int key, Object value) throws NoSuchFieldException
  {
    ...
    {
      if (key >= dynamicVars.size ())
        growVars ();
      dynamicVars.setElementAt (value, key);
    }
  } // dynamicVariable
  ...
  public Object dynamicVariable (int key) throws NoSuchFieldException
  {
    ...
    else
    {
      if (key >= dynamicVars.size ())
        growVars ();
      return dynamicVars.elementAt (key);
    }
  } // dynamicVariable

  void growVars ()
  {
    int diff = maxKey - dynamicVars.size () + 1;
