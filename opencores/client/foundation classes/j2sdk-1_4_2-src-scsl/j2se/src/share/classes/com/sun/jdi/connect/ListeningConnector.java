/*
 * @(#)ListeningConnector.java	1.10 03/01/23
 *
...
public interface ListeningConnector extends Connector {
     ...
     */
    String startListening(Map arguments) throws
                              IOException,
     ...
     * connector arguments is invalid.
     */
    void stopListening(Map arguments) throws
                           IOException,
                           IllegalConnectorArgumentsException;
     ...
     * connector arguments is invalid.
     */
    VirtualMachine accept(Map arguments) throws 
                              IOException,
                              IllegalConnectorArgumentsException;
