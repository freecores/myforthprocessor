...
final public class LdapSasl {
    ...
    private static SaslClientFactory mySaslFactory = 
    	new com.sun.security.sasl.ClientFactory();
	...
	String[] mechs = getSaslMechanismNames(authMech);
	    ...
	    // If not successful, try our own factory
	    if (saslClnt == null) {
		saslClnt = mySaslFactory.createSaslClient(
		    mechs, authzId, "ldap", server, env, cbh);
	    }
