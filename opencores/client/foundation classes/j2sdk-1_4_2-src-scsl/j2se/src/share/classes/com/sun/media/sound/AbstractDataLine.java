/*
 * @(#)AbstractDataLine.java	1.32 03/01/23
 *
...
abstract class AbstractDataLine extends AbstractLine implements DataLine {
	...
	// default CD-quality and 0.5 seconds buffer
	this(info, mixer, controls, new AudioFormat(44100.0f, 16, 2, true, Platform.isBigEndian()), 88200);
    }
	...
	long microseconds = AudioSystem.NOT_SPECIFIED;
	int frames = getFramePosition();

	if (frames != AudioSystem.NOT_SPECIFIED) {
	    microseconds = (long)(frames * 1000000.0 / getFormat().getFrameRate());
	}
