...
public interface Method extends TypeComponent, Locatable, Comparable {
     ...
     *
     * @return <code>true</code> if this method has been replaced by
     * a non-equivalent method using
     * {@link VirtualMachine#redefineClasses}.
     *
     * @since 1.4
     */
    boolean isObsolete();
     ...
     * information is not available), thus they will throw this exception.
     */
    List variablesByName(String name) throws AbsentInformationException;
