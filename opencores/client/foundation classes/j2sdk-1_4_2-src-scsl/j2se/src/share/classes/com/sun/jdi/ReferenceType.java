/*
 * @(#)ReferenceType.java	1.43 03/01/23
 *
...
public interface ReferenceType extends Type, Comparable, Accessible {
     ...
     * @since 1.4
     */
    List sourceNames(String stratum) throws AbsentInformationException;
     ...
     * @since 1.4
     */
    List sourcePaths(String stratum) throws AbsentInformationException;
     ...
     * prepared.
     */
    List methodsByName(String name);
     ...
     * prepared.
     */
    List methodsByName(String name, String signature);
     ...
     */
    List locationsOfLine(int lineNumber) throws AbsentInformationException;
