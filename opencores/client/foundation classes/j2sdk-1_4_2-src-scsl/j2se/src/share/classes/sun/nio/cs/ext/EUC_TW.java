    ...
    implements HistoricallyNamedCharset
{
    ...
    private static final byte P2 = (byte) 0xA2;
    private static final byte P3 = (byte) 0xA3;
						...
						CharBuffer dst)
	{
		...
		while (sp < sl) {
		    switch (state) {
		    case G0:
			if ( (sa[sp] & MSB) == 0) {	// ASCII
			    outputChar = (char) sa[sp];
			    inputSize = 1;
			} else if (sa[sp] == SS2) {	// Codeset 2
			    state = G2;
		    } else {				// Codeset 1
			    firstByte = sa[sp];
			    state = G1;
			...
			if (sa[sp + 1] == P2) {		// Plane 2
			    state = G3;
			} else if (sa[sp + 1] == P3) {	// Plane 3
			    state = G4;
			} else {				// Error
					     ...
					     CharBuffer dst)
	{
		...
		while (src.hasRemaining()) {
		    ...
		    case G0:
		        inputByte = src.get();
			if ((inputByte & MSB) == 0) {	// ASCII
			    outputChar = (char)inputByte;
			} else if (inputByte == SS2) {	// Codeset 2
			    state = G2;
			} else {				// Codeset 1
			    firstByte = (byte)inputByte;
			    state = G1;
			}
			break;
		    case G1:
		    ...
		    case G2:
			inputByte = src.get();
			if (inputByte == P2) {		// Plane 2
			    state = G3;
			} else if (inputByte == P3) {	// Plane 3
			    state = G4;
			} else {				// Error
			    return CoderResult.malformedForLength(2);
			}
