...
public final class System {
    private static System _this = new System();
...
*/
    ...
    public static void arraycopy(Object src,  int  srcPos,
                                        ...
                                        int length) {
      JavaArray s = (JavaArray)src;
      JavaArray d = (JavaArray)dest;
      int sstart = s.getElem(srcPos);
      int dstart = d.getElem(destPos);
      length <<= d.shift;
      #ass "sstart dstart length MOVE";
    }
