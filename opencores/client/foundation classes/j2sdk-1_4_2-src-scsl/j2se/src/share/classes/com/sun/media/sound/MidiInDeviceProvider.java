...
public class MidiInDeviceProvider extends AbstractMidiDeviceProvider {
    ...
    protected static Info[] infos = null;
    ...
    protected AbstractMidiDeviceProvider.Info createInfo(int index) {
    ...
    protected int getNumDevices() { return nGetNumDevices(); }
    protected MidiDevice[] getDeviceCache() { return devices; }
    protected void setDeviceCache(MidiDevice[] devices) { this.devices = devices; }
    protected Info[] getInfoCache() { return infos; }
    protected void setInfoCache(Info[] infos) { this.infos = infos; }
