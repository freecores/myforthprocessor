...
:LOCAL lang.Number.byteValue§-1994235392
   ...
   \ new statement
   §this A:R@
   R> -370906880 TRUE ( java.lang.Number.intValue§-370906880 ) EXECUTE-METHOD
   127 U>! NIP
   IF
      0FFFFFF00H OR
   ENDIF
...
:LOCAL lang.Number.shortValue§715813632
   1 VALLOCATE LOCAL §base0
   DUP 0 §base0 + V! LOCAL §this
   ...
   DROP
;
2VARIABLE lang.Number.serialVersionUID

A:HERE VARIABLE lang.Number§-450605568.table 2 DUP 2* CELLS ALLOT R@ ! A:CELL+
-1994235392 R@ ! A:CELL+ lang.Number.byteValue§-1994235392 VAL R@ ! A:CELL+
715813632 R@ ! A:CELL+ lang.Number.shortValue§715813632 VAL R@ ! A:CELL+
A:DROP
