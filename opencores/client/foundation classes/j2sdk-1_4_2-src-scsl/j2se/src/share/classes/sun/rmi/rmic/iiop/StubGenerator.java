/*
 * @(#)StubGenerator.java	1.45 03/01/23
 *
...
public class StubGenerator extends sun.rmi.rmic.iiop.Generator {
	...
	if (remoteInterfaces.length > 0) {
		...
		p.p(getName(remoteInterfaces[i]));
	    }
	}
    ...
    void addClassInUse(String unqualifiedName, String qualifiedName, String packageName) {
        ...
        if (currentName == null) {
            ...
            if (packageName == null) {
                ...
                // Note that this name is in use for this package
	...
	if (handleExceptions && doReturn) {
	    p.pln(getName(returnType)+" result;");
	}
