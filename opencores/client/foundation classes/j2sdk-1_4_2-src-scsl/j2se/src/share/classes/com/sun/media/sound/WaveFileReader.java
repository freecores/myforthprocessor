/*
 * @(#)WaveFileReader.java	1.28 03/01/23
 *
...
public class WaveFileReader extends SunFileReader {
	...
	AudioFormat format = new AudioFormat(encoding, (float)sampleRate, sampleSizeInBits, channels,
					     (sampleSizeInBits*channels/8), (float)sampleRate, false);
