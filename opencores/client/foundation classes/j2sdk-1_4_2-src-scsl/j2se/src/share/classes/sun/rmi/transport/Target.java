...
public final class Target {
     ...
     * exiting.
     */
    public Target(Remote impl, Dispatcher disp, RemoteStub stub, ObjID id,
		  boolean permanent)
    {
    ...
    /**
     * Returns the transport through which remote calls to
     * this target are allowed.  
     */
    Transport getExportedTransport() {
	return exportedTransport;
    }
	...
	if ((force == true) || (callCount == 0) || (disp == null)) {
	    ...
	    Enumeration enum = refSet.elements();
	    while (enum.hasMoreElements()) {
		VMID vmid = (VMID) enum.nextElement();
