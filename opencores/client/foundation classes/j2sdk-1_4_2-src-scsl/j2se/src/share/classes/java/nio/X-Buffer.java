...
public abstract class $Type$Buffer
    extends Buffer
    implements Comparable{#if[char]?, CharSequence}
{
     ...
     *
     * <p> The new buffer will be backed by the the given $fulltype$ array;
...

     ...
     *
     * <p> A $type$ buffer is not comparable to any other type of object.  </p>
     *
     * @return  A negative integer, zero, or a positive integer as this buffer
     *		is less than, equal to, or greater than the given buffer
     *
     * @throws  ClassCastException
     *          If the argument is not a $type$ buffer
     */
