    ...
    implements HistoricallyNamedCharset
{
	...
	JIS_X_0212.Decoder decoderJ0212;
	...
	private Decoder(Charset cs) {
	    ...
	    decoderJ0212 = new JIS_X_0212.Decoder(cs);
	    start = 0xa1;
	    end = 0xfe;
					    ...
					    CharBuffer dst)
	{
		...
		while (sp < sl) {
			...
			if ((b1 & 0xff) == 0x8f) {   // JIS0212
			    ...
			    b2 = sa[sp + 2] & 0xff;
			    inputSize += 2;
			    outputChar = decoderJ0212.decodeDouble(b1-0x80,
								 b2-0x80);
			} else {
			  // JIS0208
			    if (sp + 2 > sl)
	...
	JIS_X_0212.Encoder encoderJ0212;
	...
	private Encoder(Charset cs) {
	    ...
	    encoderJ0212 = new JIS_X_0212.Encoder(cs);
	    j0208Index1 = super.getIndex1();
	    j0208Index2 = super.getIndex2();
	}
