/*
 * @(#)DateFormatZoneData_zh_CN.java	1.33 03/05/01
 */
...
public final class DateFormatZoneData_zh_CN extends DateFormatZoneData
{
	...
	String AKST[] = new String[] {"\u963f\u62c9\u65af\u52a0\u6807\u51c6\u65f6\u95f4", "AKST",
				      "\u963f\u62c9\u65af\u52a0\u590f\u4ee4\u65f6", "AKDT"};
	String AMT[] = new String[] {"\u4e9a\u9a6c\u900a\u6cb3\u6807\u51c6\u65f6\u95f4", "AMT",
				     "\u4e9a\u9a6c\u900a\u590f\u4ee4\u65f6", "AMST"};
	...
	String BRT[] = new String[] {"\u5df4\u897f\u65f6\u95f4", "BRT",
				     "\u5df4\u897f\u590f\u4ee4\u65f6", "BRST"};
	...
	String ICT[] = new String[] {"\u5370\u5ea6\u652f\u90a3\u65f6\u95f4", "ICT",
				     "\u5370\u5ea6\u652f\u90a3\u590f\u4ee4\u65f6", "ICST"};
	String IRT[] = new String[] {"\u4f0a\u6717\u6807\u51c6\u65f6\u95f4", "IRT",
				     "\u4f0a\u6717\u590f\u4ee4\u65f6", "IRST"};
	...
	return new Object[][] {
	    ...
	    {"America/Guayaquil", new String[] {"\u5384\u74dc\u591a\u5c14\u65f6\u95f4", "ECT",
						"\u5384\u74dc\u591a\u5c14\u590f\u4ee4\u65f6", "ECST"}},
	    {"America/Guyana", new String[] {"\u76d6\u4e9a\u90a3\u65f6\u95f4", "GYT",
					     "\u76d6\u4e9a\u90a3\u590f\u4ee4\u65f6", "GYST"}},
	    {"America/Havana", CST},
	    ...
	    {"Antarctica/Syowa", new String[] {"\u662d\u548c\u65f6\u95f4", "SYOT",
					       "\u662d\u548c\u65f6\u95f4", "SYOT"}},
	    ...
	    {"Asia/Bangkok", ICT},
	    {"Asia/Beirut", EET},
	    {"Asia/Bishkek", new String[] {"Kirgizstan \u65f6\u95f4", "KGT",
					   "Kirgizstan \u590f\u4ee4\u65f6", "KGST"}},
	    ...
	    {"Asia/Damascus", EET},
	    {"Asia/Dubai", GST},
	    {"Asia/Dushanbe", new String[] {"Tajikistan \u65f6\u95f4", "TJT",
					    "Tajikistan \u590f\u4ee4\u65f6", "TJST"}},
	    {"Asia/Gaza", EET},
	    {"Asia/Harbin", CTT},
	    {"Asia/Hong_Kong", HKT},
	    {"Asia/Hovd", new String[] {"\u79d1\u5e03\u591a\u65f6\u95f4", "HOVT",
					"\u79d1\u5e03\u591a\u590f\u4ee4\u65f6", "HOVST"}},
	    {"Asia/Irkutsk", new String[] {"Irkutsk \u65f6\u95f4", "IRKT",
					   "Irkutsk \u590f\u4ee4\u65f6", "IRKST"}},
	    {"Asia/Istanbul", EET},
	    {"Asia/Jakarta", WIT},
	    ...
	    {"Asia/Kabul", new String[] {"\u963f\u5bcc\u6c57\u65f6\u95f4", "AFT",
					 "\u963f\u5bcc\u6c57\u590f\u4ee4\u65f6", "AFST"}},
	    {"Asia/Kamchatka", new String[] {"Petropavlovsk-Kamchatski \u65f6\u95f4", "PETT",
					     "Petropavlovsk-Kamchatski \u590f\u4ee4\u65f6", "PETST"}},
	    {"Asia/Karachi", PKT},
	    {"Asia/Kashgar", CTT},
	    ...
	    {"Asia/Tashkent", new String[] {"\u4e4c\u5179\u522b\u514b\u65af\u5766\u65f6\u95f4", "UZT",
					    "\u4e4c\u5179\u522b\u514b\u65af\u5766\u590f\u4ee4\u65f6", "UZST"}},
	    ...
	    {"Pacific/Port_Moresby", new String[] {"\u5df4\u5e03\u4e9a\u65b0\u51e0\u5185\u4e9a\u65f6\u95f4", "PGT",
						   "\u5df4\u5e03\u4e9a\u65b0\u51e0\u5185\u4e9a\u590f\u4ee4\u65f6", "PGST"}},
	    {"Pacific/Rarotonga", new String[] {"Cook \u7fa4\u5c9b\u65f6\u95f4", "CKT",
						"Cook \u7fa4\u5c9b\u590f\u4ee4\u65f6", "CKST"}},
	    {"Pacific/Saipan", ChST},
	    {"Pacific/Samoa", SAMOA},
