...
public class DnsContext extends ComponentDirContext {
	...
	try {
	    ...
	    return new NameClassPairEnumeration(nnode.getChildren());
...
class NameClassPairEnumeration implements NamingEnumeration {
    ...
    NameClassPairEnumeration(Hashtable nodes) {
	...
	return new NameClassPair(cname.toString(), className);
    }
...
class BindingEnumeration extends NameClassPairEnumeration {
    ...
    private DnsContext ctx;	// context being enumerated
...
//  }
	...
	try {
	    ...
	    return new Binding(cnameStr, obj);
