...
public class UlawCodec extends SunCodec {
	...
	} else if (sourceFormat.getEncoding().equals( AudioFormat.Encoding.ULAW)) {
	...
	if( (targetEncoding.equals( AudioFormat.Encoding.PCM_SIGNED ) && sourceFormat.getEncoding().equals( AudioFormat.Encoding.ULAW)) ||
	    (targetEncoding.equals( AudioFormat.Encoding.ULAW) && sourceFormat.getEncoding().equals( AudioFormat.Encoding.PCM_SIGNED)) ) {
	...
	if (sourceEncoding.equals(targetEncoding)) {
	    ...
	    if (sourceEncoding.equals( AudioFormat.Encoding.ULAW) &&
		...
		targetFormat = new AudioFormat( targetEncoding,
		       ...
		       targetEncoding.equals(AudioFormat.Encoding.ULAW)) {
		targetFormat = new AudioFormat( targetEncoding,
						sourceFormat.getSampleRate(),
						8,
						sourceFormat.getChannels(),
