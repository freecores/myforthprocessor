/*
 * @(#)ShapeSpanIterator.java	1.12 03/01/23
 *
...
public final class ShapeSpanIterator implements SpanIterator, PathConsumer {
     ...
     */
    public void appendPoly(int xPoints[], int yPoints[], int nPoints,
			   int xoff, int yoff)
    {
	setRule(PathIterator.WIND_EVEN_ODD);
	if (nPoints > 0) {
	    beginSubpath(xPoints[0]+xoff, yPoints[0]+yoff);
	    for (int i = 1; i < nPoints; i++) {
		appendLine(xPoints[i]+xoff, yPoints[i]+yoff);
	    }
	}
	endPath();
    }
