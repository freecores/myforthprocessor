...
public class Object {
	...
	return JavaArray.createString(length, string) + "@" + Integer.toHexString(hashCode());
    }
    ...
    {
      #ass "BEGIN " +
           "      MILLISECONDS 2@ BEGIN 2DUP MILLISECONDS 2@ D- D0= INVERT UNTIL 2DROP " +
           "      timeout 0 1 D- 2DUP TO timeout D0= " +
           "UNTIL";
    }
