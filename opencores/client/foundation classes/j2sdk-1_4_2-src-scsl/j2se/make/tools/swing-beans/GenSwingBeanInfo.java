/*
 * @(#)GenSwingBeanInfo.java	1.23 03/01/23
 *
            ...
            if (pds[i].getReadMethod() != null) {
                ...
                if (hash_match) {
                    if ((dbi.beanflags & DocBeanInfo.BOUND) != 0) { 
                        code += "               BOUND, Boolean.TRUE,\n";
                    } else {
                        code += "               BOUND, Boolean.FALSE,\n";          
                    }
                }

                if (pds[i].isConstrained()) {
                    code += "         CONSTRAINED, Boolean.TRUE,\n";
                }

                if (pds[i].getPropertyEditorClass() != null) {
                    String className = pds[i].getPropertyEditorClass().getName();
                    code += " PROPERTYEDITORCLASS, " + className + ".class,\n";
                } else if ((hash_match) && (!(dbi.propertyeditorclass.equals("null")))) {
                    code += " PROPERTYEDITORCLASS, " + dbi.propertyeditorclass + ".class,\n";
                }
                ...
                if (!pds[i].getDisplayName().equals(pds[i].getName())) {
                    code += "         DISPLAYNAME, \"" + pds[i].getDisplayName() + "\",\n";
                }
                ...
                code += "    SHORTDESCRIPTION, \"" + pds[i].getShortDescription() + "\",\n";
