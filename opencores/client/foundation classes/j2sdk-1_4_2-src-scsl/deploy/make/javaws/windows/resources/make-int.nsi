...
# @(#)make-int.nsi	1.36 02/08/08
#
# This is also the script for the Merlin
# bundle.  We invoke the installer with
# $1 == bundled to tell the script this.
#
...
StringTable strings_fr.txt 0x040C
StringTable strings_de.txt 0x0407
StringTable strings_it.txt 0x0410
StringTable strings_es.txt 0x080A
StringTable strings_sv.txt 0x041D
StringTable strings_ko.txt 0x0412
StringTable strings_ja.txt 0x0411
StringTable strings_zh_TW.txt 0x0404
StringTable strings_zh_CN.txt 0x0804
...
File Readme_ko.html
File Readme_ja.html
File Readme_zh_TW.html
File Readme_zh_CN.html
...
# MERLIN ONLY
If "$1==/bundled"
ExecWait '"$INSTDIR\helper.exe" 6 "$2" "$3" "$INSTDIR"
EndIf
# Create the ini file that the helper DLL will later create javaws.cfg from
WriteINIStr "$INSTDIR\foo.ini" foo jreVersion "$3"
# END MERLIN ONLY
...
Delete $INSTDIR\javaws-l10n.jar
...
Delete $INSTDIR\Readme_fr.html
Delete $INSTDIR\Readme_de.html
Delete $INSTDIR\Readme_it.html
Delete $INSTDIR\Readme_es.html
Delete $INSTDIR\Readme_sv.html
Delete $INSTDIR\Readme_ko.html
Delete $INSTDIR\Readme_ja.html
Delete $INSTDIR\Readme_zh_TW.html
Delete $INSTDIR\Readme_zh_CN.html
