...
#define JAVA_PLUGIN_JNIJS_GET_NATIVE   JNIJS_BASE 
#define JAVA_PLUGIN_JNIJS_TOSTRING     (JNIJS_BASE + 1)
#define JAVA_PLUGIN_JNIJS_FINALIZE     (JNIJS_BASE + 2)
#define JAVA_PLUGIN_JNIJS_CALL         (JNIJS_BASE + 3)
#define JAVA_PLUGIN_JNIJS_EVAL         (JNIJS_BASE + 4)
#define JAVA_PLUGIN_JNIJS_GETMEMBER    (JNIJS_BASE + 5)
#define JAVA_PLUGIN_JNIJS_SETMEMBER    (JNIJS_BASE + 6)
#define JAVA_PLUGIN_JNIJS_REMOVEMEMBER (JNIJS_BASE + 7)
#define JAVA_PLUGIN_JNIJS_GETSLOT      (JNIJS_BASE + 8)
#define JAVA_PLUGIN_JNIJS_SETSLOT      (JNIJS_BASE + 9)
