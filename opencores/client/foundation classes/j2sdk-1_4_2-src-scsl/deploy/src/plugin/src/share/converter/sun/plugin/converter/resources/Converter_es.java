/*
 * @(#)Converter_es.java	1.23 03/04/28
 *
...
public class Converter_es extends ListResourceBundle {
   ...
   { "nottemplatefile_dialog.caption", "No es un archivo de plantillas"},
    ...
    { "button.quit", "Salir"},
    { "button.advanced", "Opciones avanzadas..."},
    { "button.help", "Ayuda"},
