...
final class NSRegistry
{
    ...
    */
     ...
     *    } REGHDR;
     */
    protected NSRegistry open(File regFile) {
	if (in != null) {
	    return this;
	}
	try {
	...
	{
	    Trace.printException(e, ResourceHandler.getMessage("proxy.prefsfile.nsreg_error"),
				 ResourceHandler.getMessage("proxy.error_caption"));
	}
    ...
    {
	DialogFactory.showErrorDialog(ResourceHandler.getMessage("proxy.prefsfile.nsreg_error"),
				      ResourceHandler.getMessage("proxy.error_caption"));
    }
}
