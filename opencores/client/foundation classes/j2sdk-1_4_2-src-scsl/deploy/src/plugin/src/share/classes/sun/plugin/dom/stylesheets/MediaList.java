 ...
 * @since DOM Level 2
 */
final class MediaList implements org.w3c.dom.stylesheets.MediaList 
{
     ...
     */
    public MediaList(DOMObject obj)
    {
	this.obj = obj;
    }
    ...
    {
    	return DOMObjectHelper.getStringMemberNoEx(obj, "mediaText");	
    }

    public void setMediaText(String mediaText)
                             throws DOMException
    {
	DOMObjectHelper.setStringMember(obj, "mediaText", mediaText);
    }
	...
	DOMObjectHelper.callStringMethod(obj, "deleteMedium", args);
    }
	...
	DOMObjectHelper.callStringMethod(obj, "appendMedium", args);
    }
}
