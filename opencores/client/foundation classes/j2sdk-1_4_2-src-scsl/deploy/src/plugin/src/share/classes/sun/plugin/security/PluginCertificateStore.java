/*
 * @(#)PluginCertificateStore.java	1.30 03/01/27
 *
...
/**
 * PluginCertificateStore is a class that represents the permanent certificate 
 ...
 * encountered.
 */
public final class PluginCertificateStore implements CertificateStore
{
	...
	if (contains(cert) == false)
	{
	    ...
	    Trace.msgSecurityPrintln("jpicertstore.cert.added", new Object[]{ alias});
	}
    }
	...
	Trace.msgSecurityPrintln("jpicertstore.cert.removed", new Object[] {alias});
    }
