/*
 * @(#)PluginSysUtil.java	1.3 03/01/23
 *
...
public final class PluginSysUtil {
    ...
    /**
     * <p>
     * Execute the <code>PluginSysAction</code> in plugin system thread group
     * </p>
     */    
    public static Object execute(PluginSysAction action) 
	throws Exception {
	...
	public SysExecutionThread(PluginSysAction action) {
