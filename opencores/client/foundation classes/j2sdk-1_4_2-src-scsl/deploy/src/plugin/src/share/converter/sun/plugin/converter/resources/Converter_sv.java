/*
 * @(#)Converter_sv.java	1.30 03/01/23
 *
...
public class Converter_sv extends ListResourceBundle {
    ...
    { "about_dialog.caption", "Om Java(tm) Plug-in HTML Converter" },
    ...
    { "button.quit", "Avsluta"},
    { "button.advanced", "Avancerade alternativ..."},
    { "button.help", "Hj\u00e4lp"},
    ...
    { "progress_dialog.totalapplet", "Antal funna appletar:"},
    ...
    { "static.versioning.label", "Java-versionering f\u00f6r Applets:"},
        { "static.versioning.radio.button", "Anv\u00e4nd endast Java {0}"},
    { "static.versioning.text", "Applets kommer endast att anv\u00e4nda denna specifika versionen av Java. Om den inte \u00e4r installerad, kommer den, om m\u00f6jligt, att automatiskt laddas ner. Annars kommer anv\u00e4ndaren till en sida f\u00f6r manuell nerladdning. Se  f\u00f6r detaljer om den automatiska nerladdningsprocessen och End of Life (EOL)-policy f\u00f6r alla Java-releaser."},
        { "dynamic.versioning.radio.button", "Anv\u00e4nd vilken Java {0} som helst eller h\u00f6gre"},
        { "dynamic.versioning.text", "Om ingen s\u00e5dan version finns installerad kommer den nuvarande standardnerladdingen f\u00f6r Java {0}-familjen, om m\u00f6jligt, att laddas ner automatiskt.  Annars kommer anv\u00e4ndaren att omdirigeras till en manuell nerladdnignssida."},
    ...
    { "plugin_converter.appletconv", "Konvertering av appletar"},
    ...
    { "plugin_converter.appletfound", "  Antal funna appletar: "},
    ...
    { "plugin_converter.donefound", "Klart  Antal funna appletar: "},
    { "plugin_converter.seetrace", "Fel i fil - se sp\u00e5rning nedan"},
    { "plugin_converter.noapplet", "Inga appletar i filen "},
