...
#pragma ident "@(#)assembler_sparc.hpp	1.143 03/01/23 10:59:07 JVM"
#endif
/*
...
REGISTER_DECLARATION(Register, Gframe_size   , G1); // SAME REG as inline_cache_klass
...
REGISTER_DECLARATION(Register, IsavedSP         , I5); // Saved SP before bumping for locals
REGISTER_DECLARATION(Register, IsizeCalleeParms , I4); // Saved size of Callee parms used to pop arguments
...
REGISTER_DECLARATION(Register, IdispatchTables  , I2); // Base address of the bytecode dispatch tables
...
#define IsizeCalleeParms    AS_REGISTER(Register, IsizeCalleeParms)
...
public:
 ...
 public:
  ...
  inline void jmpl( Register s1, Register s2, Register d );
  inline void jmpl( Register s1, int simm13a, Register d, RelocationHolder const& rspec = RelocationHolder() );
  ...
  inline void wrccr(  Register d) { v9_only(); emit_long( op(arith_op) | rs1(d) | op3(wrreg_op3) | u_field(2, 29, 25)); }
...
class MacroAssembler: public Assembler {
 ...
 public:
  ...
  // nWords = 0 would return to call instruction
  inline void ret(  int nWords = 2 ) { jmpl( I7, nWords * BytesPerInstWord, G0 ); }
  inline void retl( int nWords = 2 ) { jmpl( O7, nWords * BytesPerInstWord, G0 ); }
  ...
  inline void setsw(  int value, Register d, RelocationHolder const& rspec = RelocationHolder() );
         void setx( jlong value, Register tmp, Register d, relocInfo::relocType rtype = relocInfo
::none);
 ...
 public:
  ...
  void set_last_Java_frame(Register last_java_sp, Register post_Java_state);
