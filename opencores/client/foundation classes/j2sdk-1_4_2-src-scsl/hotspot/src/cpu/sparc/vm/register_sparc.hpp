...
#pragma ident "@(#)register_sparc.hpp	1.14 03/01/23 11:02:06 JVM"
#endif
/*
...
const SPARC_ARGS_IN_REGS_NUM = 6;
...
class SingleFloatRegisterImpl *SingleFloatRegister;
...
class DoubleFloatRegisterImpl *DoubleFloatRegister;
...
class QuadFloatRegisterImpl *QuadFloatRegister;
