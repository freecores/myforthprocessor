...
#pragma ident "@(#)frame_sparc.inline.hpp	1.56 03/02/06 17:20:20 JVM"
#endif
/*
...
inline address* frame::O7_addr() const  { return after_save().I7_addr(); }

inline address* frame::I0_addr() const  { return (address*) &sp()[ I0->sp_offset_in_saved_window()]; }  
inline address* frame::O0_addr() const  { return after_save().I0_addr(); }
