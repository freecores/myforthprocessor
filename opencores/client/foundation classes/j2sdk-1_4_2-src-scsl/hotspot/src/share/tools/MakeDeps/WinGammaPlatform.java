/*
 * @(#)WinGammaPlatform.java	1.11 03/01/23 11:12:17
 *
...
public class WinGammaPlatform extends Platform {
	...
	dspFile.println("# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib uuid.lib Wsock32.lib winmm.lib /nologo /base:\"0x8000000\" /subsystem:windows /dll /debug /machine:I386 /out:\"" + dllLoc + "\\jvm.dll\" /export:JNI_GetDefaultJavaVMInitArgs /export:JNI_CreateJavaVM /export:JNI_GetCreatedJavaVMs /export:jio_snprintf /export:jio_printf /export:jio_fprintf /export:jio_vfprintf /export:jio_vsnprintf /export:JVM_FunctionAtStart /export:JVM_FunctionAtEnd");
	...
	dspFile.println("# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib Wsock32.lib winmm.lib /nologo /base:\"0x8000000\" /subsystem:windows /dll /debug /machine:I386 /out:\"" + dllLoc + "\\jvm_g.dll\" /export:JNI_GetDefaultJavaVMInitArgs /export:JNI_CreateJavaVM /export:JNI_GetCreatedJavaVMs /export:jio_snprintf /export:jio_printf /export:jio_fprintf /export:jio_vfprintf /export:jio_vsnprintf /export:opnames /export:JVM_FunctionAtStart /export:JVM_FunctionAtEnd");
