...
#pragma ident "@(#)vmStructs.cpp	1.97 03/01/27 08:28:56 JVM"
#endif
/*
...
#define VM_STRUCTS(nonstatic_field, static_field, unchecked_nonstatic_field, volatile_nonstatic_field, nonproduct_nonstatic_field, nonproduct_noncore_nonstatic_field, c2_nonstatic_field, noncore_nonstatic_field, noncore_static_field, unchecked_c1_static_field, unchecked_c2_static_field, last_entry) \
                                                                                                                                     \
  /******************************************************************/                                                               \
  ...
  nonstatic_field(methodOopDesc,               _exception_table,                              typeArrayOop)                          \
  ...
  nonstatic_field(methodOopDesc,               _name_index,                                   u2)                                    \
  nonstatic_field(methodOopDesc,               _signature_index,                              u2)                                    \
  c2_nonstatic_field(methodOopDesc,            _interpreter_throwout_count,                   u2)                                    \
  nonstatic_field(methodOopDesc,               _access_flags,                                 AccessFlags)                           \
  nonstatic_field(methodOopDesc,               _code_size,                                    u2)                                    \
  ...
  nonstatic_field(methodOopDesc,               _code,                                         nmethod*)                              \
  nonstatic_field(methodOopDesc,               _interpreter_entry,                            address)                               \
  noncore_nonstatic_field(methodOopDesc,       _from_compiled_code_entry_point,               address)                               \
  nonproduct_nonstatic_field(methodOopDesc,    _bci_histogram,                                int*)                                  \
  ...
  nonstatic_field(symbolOopDesc,               _next,                                         symbolOop)                             \
  ...
  nonstatic_field(JNIid,                       _offset,                                       int)                                   \
   volatile_nonstatic_field(JNIid,             _resolved_method,                              methodOop)                             \
   volatile_nonstatic_field(JNIid,             _resolved_receiver,                            klassOop)                              \
                                                                                                                                     \
  /************/                                                                                                                     \
  /* Universe */                                                                                                                     \
  /************/                                                                                                                     \
  ...
  noncore_static_field(Universe,               _compiledICHolderKlassObj,                     klassOop)                              \
     ...
     static_field(Universe,                    _out_of_memory_error_instance,                 oop)                                   \
  ...
  nonstatic_field(ThreadLocalAllocBuffer,      _has_terminated,                               bool)                                  \
     static_field(ThreadLocalAllocBuffer,      _log2_fragmentation_ratio,                     size_t)                                \
     static_field(ThreadLocalAllocBuffer,      _max_size,                                     size_t)                                \
                                                                                                                                     \
  ...
  /***************/                                                                                                                  \
                                                                                                                                     \
     static_field(SymbolTable,                 _buckets,                                      symbolTableBucket*)                    \
                                                                                                                                     \
  /********************/                                                                                                             \
  /* SystemDictionary */                                                                                                             \
  /********************/                                                                                                             \
                                                                                                                                     \
     static_field(SystemDictionary,            _buckets,                                      SystemDictionaryEntry**)               \
     static_field(SystemDictionary,            _java_system_loader,                           oop)                                   \
  nonstatic_field(SystemDictionaryEntry,       _next,                                         SystemDictionaryEntry*)                \
  nonstatic_field(SystemDictionaryEntry,       _klass,                                        klassOop)                              \
  nonstatic_field(SystemDictionaryEntry,       _loader,                                       oop)                                   \
  nonstatic_field(SystemDictionaryEntry,       _pd_set,                                       ProtectionDomainEntry*)                \
  ...
  /*********************/                                                                                                            \
                                                                                                                                     \
  nonstatic_field(symbolTableBucket,           _entry,                                        symbolOop)                             \
                                                                                                                                     \
  /********************************/                                                                                                 \
  ...
  noncore_nonstatic_field(nmethod,             _invocation_count,                             int)                                   \
  ...
  noncore_nonstatic_field(nmethod,             _max_nof_monitors,                             int)                                   \
  noncore_nonstatic_field(nmethod,             _max_nof_locals,                               int)                                   \
...
#define VM_TYPES(declare_type, declare_toplevel_type, declare_oop_type, declare_integer_type, declare_unsigned_integer_type, declare_noncore_type, declare_noncore_toplevel_type, declare_noncore_unsigned_integer_type, declare_c1_toplevel_type, declare_c2_type, declare_c2_toplevel_type, last_entry) \
                                                                          \
  /*************************************************************/         \
  ...
  declare_toplevel_type(Generation::Name)                                 \
  declare_toplevel_type(GenerationSpec)                                   \
  declare_toplevel_type(HeapWord)                                         \
  declare_toplevel_type(MemRegion)                                        \
  declare_toplevel_type(PermGen::Name)                                    \
  declare_toplevel_type(PermanentGenerationSpec)                          \
  declare_toplevel_type(ThreadLocalAllocBuffer)                           \
  declare_toplevel_type(Universe::JVMPIState)                             \
  ...
  declare_toplevel_type(symbolTableBucket)                                \
  declare_toplevel_type(symbolTableBucket*)                               \
                                                                          \
  /********************/                                                  \
  /* SystemDictionary */                                                  \
  ...
  declare_toplevel_type(SystemDictionaryEntry)                            \
  ...
  declare_toplevel_type(ThreadShadow)                                     \
           ...
           declare_type(SuspendCheckerThread, Thread)                     \
           declare_type(JavaThread, Thread)                               \
           declare_type(JVMPIDaemonThread, JavaThread)                    \
           declare_type(DebuggerThread, JavaThread)                       \
  ...
  declare_c2_type(DeoptimizationBlob, CodeBlob)                           \
  declare_c2_type(ExceptionBlob,      CodeBlob)                           \
  declare_c2_type(I2CAdapter,         CodeBlob)                           \
  declare_c2_type(OSRAdapter,         CodeBlob)                           \
...
#define VM_INT_CONSTANTS(declare_constant, declare_preprocessor_constant, declare_noncore_constant, declare_c1_constant, declare_c2_constant, declare_c2_preprocessor_constant, last_entry) \
  ...
  /********************/                                                  \
                                                                          \
  declare_preprocessor_constant("ALIGN_ALL_OBJECTS", ALIGN_ALL_OBJECTS)   \
  declare_preprocessor_constant("ALIGN_DOUBLE_FIELDS", ALIGN_DOUBLE_FIELDS) \
  declare_preprocessor_constant("ALIGN_DOUBLE_ELEMENTS", ALIGN_DOUBLE_ELEMENTS) \
  declare_preprocessor_constant("ALIGN_LONG_FIELDS", ALIGN_LONG_FIELDS)   \
  declare_preprocessor_constant("ALIGN_LONG_ELEMENTS", ALIGN_LONG_ELEMENTS) \
                                                                          \
  /************************************************/                      \
  /* Shared JavaThread constants (see thread.hpp) */                      \
  /************************************************/                      \
                                                                          \
  declare_constant(JavaFrameAnchor::not_at_call_bit)                      \
                                                                          \
  /********************************************/                          \
  ...
  declare_constant(_thread_in_native_blocked)                             \
                                                                          \
  /******************************/                                        \
  ...
  /**********************/                                                \
                                                                          \
  declare_c1_constant(Runtime1::osr_frame_return_id)                      \
                                                                          \
  /*********************/                                                 \
  /* Matcher (C2 only) */                                                 \
  /*********************/                                                 \
  ...
  /********************************/                                      \
                                                                          \
  declare_constant(UseC2CallingConventions)                               \
...
VMStructEntry VMStructs::localHotSpotVMStructs[] = {
  VM_STRUCTS(GENERATE_NONSTATIC_VM_STRUCT_ENTRY, GENERATE_STATIC_VM_STRUCT_ENTRY, GENERATE_UNCHECKED_NONSTATIC_VM_STRUCT_ENTRY, GENERATE_NONSTATIC_VM_STRUCT_ENTRY, GENERATE_NONPRODUCT_NONSTATIC_VM_STRUCT_ENTRY, GENERATE_NONPRODUCT_NONCORE_NONSTATIC_VM_STRUCT_ENTRY, GENERATE_C2_NONSTATIC_VM_STRUCT_ENTRY, GENERATE_NONCORE_NONSTATIC_VM_STRUCT_ENTRY, GENERATE_NONCORE_STATIC_VM_STRUCT_ENTRY, GENERATE_C1_UNCHECKED_STATIC_VM_STRUCT_ENTRY, GENERATE_C2_UNCHECKED_STATIC_VM_STRUCT_ENTRY, GENERATE_VM_STRUCT_LAST_ENTRY)
...
void
VMStructs::init() {
  VM_STRUCTS(CHECK_NONSTATIC_VM_STRUCT_ENTRY, CHECK_STATIC_VM_STRUCT_ENTRY, CHECK_NO_OP, CHECK_VOLATILE_NONSTATIC_VM_STRUCT_ENTRY, CHECK_NONPRODUCT_NONSTATIC_VM_STRUCT_ENTRY, CHECK_NONPRODUCT_NONCORE_NONSTATIC_VM_STRUCT_ENTRY, CHECK_C2_NONSTATIC_VM_STRUCT_ENTRY, CHECK_NONCORE_NONSTATIC_VM_STRUCT_ENTRY, CHECK_NONCORE_STATIC_VM_STRUCT_ENTRY, CHECK_NO_OP, CHECK_NO_OP, CHECK_SENTINEL);
  VM_STRUCTS_CPU(CHECK_NONSTATIC_VM_STRUCT_ENTRY, CHECK_STATIC_VM_STRUCT_ENTRY, CHECK_NO_OP, CHECK_VOLATILE_NONSTATIC_VM_STRUCT_ENTRY, CHECK_NONPRODUCT_NONSTATIC_VM_STRUCT_ENTRY, CHECK_NONPRODUCT_NONCORE_NONSTATIC_VM_STRUCT_ENTRY, CHECK_C2_NONSTATIC_VM_STRUCT_ENTRY, CHECK_NONCORE_NONSTATIC_VM_STRUCT_ENTRY, CHECK_NONCORE_STATIC_VM_STRUCT_ENTRY, CHECK_NO_OP, CHECK_NO_OP, CHECK_SENTINEL);
  VM_STRUCTS_OS_CPU(CHECK_NONSTATIC_VM_STRUCT_ENTRY, CHECK_STATIC_VM_STRUCT_ENTRY, CHECK_NO_OP, CHECK_VOLATILE_NONSTATIC_VM_STRUCT_ENTRY, CHECK_NONPRODUCT_NONSTATIC_VM_STRUCT_ENTRY, CHECK_NONPRODUCT_NONCORE_NONSTATIC_VM_STRUCT_ENTRY, CHECK_C2_NONSTATIC_VM_STRUCT_ENTRY, CHECK_NONCORE_NONSTATIC_VM_STRUCT_ENTRY, CHECK_NONCORE_STATIC_VM_STRUCT_ENTRY, CHECK_NO_OP, CHECK_NO_OP, CHECK_SENTINEL);
...
#ifndef _WINDOWS
  debug_only(VM_STRUCTS(ENSURE_FIELD_TYPE_PRESENT, CHECK_NO_OP, CHECK_NO_OP, CHECK_NO_OP, CHECK_NO_OP, CHECK_NO_OP, CHECK_NO_OP, CHECK_NO_OP, CHECK_NO_OP, CHECK_NO_OP, CHECK_NO_OP, CHECK_SENTINEL));
  debug_only(VM_STRUCTS(CHECK_NO_OP, ENSURE_FIELD_TYPE_PRESENT, CHECK_NO_OP, ENSURE_FIELD_TYPE_PRESENT, ENSURE_NONPRODUCT_FIELD_TYPE_PRESENT, ENSURE_NONPRODUCT_NONCORE_FIELD_TYPE_PRESENT, ENSURE_C2_FIELD_TYPE_PRESENT, ENSURE_NONCORE_FIELD_TYPE_PRESENT, ENSURE_NONCORE_FIELD_TYPE_PRESENT, CHECK_NO_OP, CHECK_NO_OP, CHECK_SENTINEL));
  ...
  debug_only(VM_STRUCTS_OS_CPU(ENSURE_FIELD_TYPE_PRESENT, ENSURE_FIELD_TYPE_PRESENT, CHECK_NO_OP, ENSURE_FIELD_TYPE_PRESENT, ENSURE_NONPRODUCT_FIELD_TYPE_PRESENT, ENSURE_NONPRODUCT_NONCORE_FIELD_TYPE_PRESENT, ENSURE_C2_FIELD_TYPE_PRESENT, ENSURE_NONCORE_FIELD_TYPE_PRESENT, ENSURE_NONCORE_FIELD_TYPE_PRESENT, CHECK_NO_OP, CHECK_NO_OP, CHECK_SENTINEL));
#endif
}
