/*
 * @(#)HotSpotAgent.java	1.25 03/01/23 11:14:00
 *
...
public class HotSpotAgent {
  ...
  /** This is used in server mode to be able to detach cleanly from a
      local process */
  ...
  private void setupDebuggerLinux() {
    ...
    if (cpu.equals("x86")) {
      ...
      throw new DebuggerException("Linux only supported on x86");
    }
