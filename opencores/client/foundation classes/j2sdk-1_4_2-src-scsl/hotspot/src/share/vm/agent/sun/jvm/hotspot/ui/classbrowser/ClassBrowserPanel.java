/*
 * @(#)ClassBrowserPanel.java	1.2 03/01/23 11:49:58
 *
...
public class ClassBrowserPanel extends JPanel implements ActionListener {
   ...
   private JEditorPane         classesEditor;
   ...
   public ClassBrowserPanel() {
      ...
      classesEditor = new JEditorPane();
      classesEditor.setContentType("text/html");
      classesEditor.setEditable(false);
