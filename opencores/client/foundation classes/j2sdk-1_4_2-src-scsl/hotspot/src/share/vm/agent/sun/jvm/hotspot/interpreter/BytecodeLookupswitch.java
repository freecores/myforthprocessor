/*
 * @(#)BytecodeLookupswitch.java	1.4 03/01/23 11:36:55
 *
...
public class BytecodeLookupswitch extends Bytecode {
  ...
  public String toString() {
    ...
    buf.append(spaces);
    buf.append("default: ");
    buf.append(new Integer(bci() + defaultOffset()).toString());
    buf.append(comma);
    int i = numberOfPairs() - 1;
    while (i-- > 0) {
      LookupswitchPair pair = pairAt(i);
      buf.append("case ");
      buf.append(new Integer(pair.match()).toString());
      buf.append(':');
      buf.append(new Integer(bci() + pair.offset()).toString());
      buf.append(comma);
    }
