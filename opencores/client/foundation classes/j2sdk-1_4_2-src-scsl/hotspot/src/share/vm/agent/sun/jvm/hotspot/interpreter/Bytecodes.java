/*
 * @(#)Bytecodes.java	1.6 03/01/23 11:37:32
 *
...
public class Bytecodes {
  ...
  // JVM bytecodes
  public static final int _fast_igetfield              = number_of_java_codes;
  public static final int _fast_agetfield              = 204;
  public static final int _fast_aload_0                = 205;
  public static final int _fast_iaccess_0              = 206;
  public static final int _fast_aaccess_0              = 207;
  public static final int _fast_linearswitch           = 208;
  public static final int _fast_binaryswitch           = 209;

  public static final int _shouldnotreachhere   = 210; // For debugging

  public static final int number_of_codes       = 211;
  ...
  public static void check(int code) {
    if (Assert.ASSERTS_ENABLED) {
      Assert.that(isDefined(code), "illegal code");
    }
  }
  public static void wideCheck(int code) {
    if (Assert.ASSERTS_ENABLED) {
      Assert.that(wideIsDefined(code), "illegal code");
    }
  }
  ...
  public static boolean   safepointSafe(int code) { check(code);      return _safepoint_safe[code]; }
  ...
  private static boolean[]   _safepoint_safe;
  ...
  static {
    ...
    _safepoint_safe = new boolean[number_of_codes];
  ...
  //  private static boolean[]   _safepoint_safe = new boolean[number_of_codes];
  ...
  private static void initialize() {
    ...
    def(_ifeq                , "ifeq"                , "boo"  , null    , BasicType.getTVoid()   , -1, false, false);
    def(_ifne                , "ifne"                , "boo"  , null    , BasicType.getTVoid()   , -1, false, false);
    def(_iflt                , "iflt"                , "boo"  , null    , BasicType.getTVoid()   , -1, false, false);
    def(_ifge                , "ifge"                , "boo"  , null    , BasicType.getTVoid()   , -1, false, false);
    def(_ifgt                , "ifgt"                , "boo"  , null    , BasicType.getTVoid()   , -1, false, false);
    def(_ifle                , "ifle"                , "boo"  , null    , BasicType.getTVoid()   , -1, false, false);
    def(_if_icmpeq           , "if_icmpeq"           , "boo"  , null    , BasicType.getTVoid()   , -2, false, false);
    def(_if_icmpne           , "if_icmpne"           , "boo"  , null    , BasicType.getTVoid()   , -2, false, false);
    def(_if_icmplt           , "if_icmplt"           , "boo"  , null    , BasicType.getTVoid()   , -2, false, false);
    def(_if_icmpge           , "if_icmpge"           , "boo"  , null    , BasicType.getTVoid()   , -2, false, false);
    def(_if_icmpgt           , "if_icmpgt"           , "boo"  , null    , BasicType.getTVoid()   , -2, false, false);
    def(_if_icmple           , "if_icmple"           , "boo"  , null    , BasicType.getTVoid()   , -2, false, false);
    def(_if_acmpeq           , "if_acmpeq"           , "boo"  , null    , BasicType.getTVoid()   , -2, false, false);
    def(_if_acmpne           , "if_acmpne"           , "boo"  , null    , BasicType.getTVoid()   , -2, false, false);
    def(_goto                , "goto"                , "boo"  , null    , BasicType.getTVoid()   ,  0, false, false);
    ...
    def(_ireturn             , "ireturn"             , "b"    , null    , BasicType.getTInt()    , -1, true , false);
    def(_lreturn             , "lreturn"             , "b"    , null    , BasicType.getTLong()   , -2, true , false);
    def(_freturn             , "freturn"             , "b"    , null    , BasicType.getTFloat()  , -1, true , false);
    def(_dreturn             , "dreturn"             , "b"    , null    , BasicType.getTDouble() , -2, true , false);
    def(_areturn             , "areturn"             , "b"    , null    , BasicType.getTObject() , -1, true , false);
    def(_return              , "return"              , "b"    , null    , BasicType.getTVoid()   ,  0, true , false);
    ...
    def(_ifnull              , "ifnull"              , "boo"  , null    , BasicType.getTVoid()   , -1, false, false);
    def(_ifnonnull           , "ifnonnull"           , "boo"  , null    , BasicType.getTVoid()   , -1, false, false);
    def(_goto_w              , "goto_w"              , "boooo", null    , BasicType.getTVoid()   ,  0, false, false);
    def(_jsr_w               , "jsr_w"               , "boooo", null    , BasicType.getTInt()    ,  0, false);
    def(_breakpoint          , "breakpoint"          , ""     , null    , BasicType.getTVoid()   ,  0, true , true);
  ...
  private static void def(int code, String name, String format, String wide_format, int result_type, int depth, boolean can_trap) {
    def(code, name, format, wide_format, result_type, depth, can_trap, true);
  }
  ...
  private static void def(int code, String name, String format, String wide_format, int result_type, int depth, boolean can_trap, int java_code) {
    def(code, name, format, wide_format, result_type, depth, can_trap, java_code, true);
  }
  ...
  private static void def(int code, String name, String format, String wide_format, int result_type, int depth, boolean can_trap, int java_code, boolean safepoint_safe) {
    ...
    _safepoint_safe[code] = safepoint_safe;
