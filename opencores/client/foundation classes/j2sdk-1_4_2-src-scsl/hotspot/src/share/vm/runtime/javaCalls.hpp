...
#pragma ident "@(#)javaCalls.hpp	1.69 03/01/23 12:23:24 JVM"
#endif
/*
...
class JavaCallWrapper: StackObj {
 ...
 private:
  ...
  bool             _is_handling_implicit_exception;   // the saved handling implicit exception bit

  JavaValue*       _result;                 // result value

  bool             _in_native_code;         // (JVMDI only) restore whether thread was in native code before call
 ...
 public:
  ...
  #include "incls/_javaCalls_pd.hpp.incl"
