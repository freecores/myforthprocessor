...
#pragma ident "@(#)c1_GraphBuilder.hpp	1.54 03/01/23 11:54:03 JVM"
#endif
// 
...
class GraphBuilder VALUE_OBJ_CLASS_SPEC {
 private:
  ...
  // inliners
  bool try_inline(ciMethod* callee);
  bool try_inline_intrinsics(ciMethod* callee);
  bool try_inline_full      (ciMethod* callee);
  ...
  void append_unsafe_get_obj32(ciMethod* callee, BasicType t);
  void append_unsafe_put_obj32(ciMethod* callee, BasicType t);
  void append_unsafe_get_obj(ciMethod* callee, BasicType t);
  void append_unsafe_put_obj(ciMethod* callee, BasicType t);
