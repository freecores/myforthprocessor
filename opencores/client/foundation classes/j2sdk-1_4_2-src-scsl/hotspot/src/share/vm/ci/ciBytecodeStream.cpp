...
#pragma ident "@(#)ciBytecodeStream.cpp	1.10 03/02/28 09:18:06 JVM"
#endif
/*
...
ciInstanceKlass* ciBytecodeStream::get_declared_method_holder() {
  bool ignore;
  ...
  return CURRENT_ENV->get_klass_by_index(method()->holder(), get_method_holder_index(), ignore)->as_instance_klass();
}
