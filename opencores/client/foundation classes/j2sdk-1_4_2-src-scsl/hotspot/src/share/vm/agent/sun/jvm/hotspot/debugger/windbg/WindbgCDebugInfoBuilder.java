/*
 * @(#)WindbgCDebugInfoBuilder.java	1.2 03/01/23 11:35:36
 *
      ...
      while (!iter.typeStringDone()) {
        ...
        case LF_ENUM: {
          ...
          if ((name == null) || (name.equals(""))) {
            ...
            enum = new BasicEnumType(name, getTypeByIndex(iter.getEnumType()));
          }
