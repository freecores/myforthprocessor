...
#pragma ident "@(#)binaryTreeDictionary.cpp	1.23 03/01/23 12:06:47 JVM"
#endif
/*
...
void BinaryTreeDictionary::printDictCensus(void) const {
  ...
  tty->print("%4s\t\t" "%7d\t" "%7d\t" "%7d\t" "%7d\t" "%7d\t" "%7d\t"
             "%7d\t"   "%7d\t" "%7d\t" "%7d\t"     "\n",
             "totl",
             ptc.totals()->bfrSurp(), 
	     ptc.totals()->surplus(), 
  ...
  tty->print("totalFree(words): %7d growth: %8.5f  deficit: %8.5f\n",
              ptc.totalFree(),
