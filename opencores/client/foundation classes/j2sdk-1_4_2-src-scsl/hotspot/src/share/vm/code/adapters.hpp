...
#pragma ident "@(#)adapters.hpp	1.41 03/01/23 11:59:10 JVM"
#endif
/*
...
class BasicAdapter : public CodeBlob {
  ...
  BasicAdapter* _link; 
 public:
  BasicAdapter(CodeBuffer *cb, int header_size, int size, int frame_size, OopMapSet* oop_maps) :
       CodeBlob(cb, header_size, size, frame_size, oop_maps) {};
