...
#pragma ident "@(#)virtualspace.hpp	1.26 03/01/23 12:26:53 JVM"
#endif
/*
...
class ReservedSpace VALUE_OBJ_CLASS_SPEC {
 ...
 private:
  ...
  void initialize(size_t size, size_t forced_base_alignment, bool ism);

 public:
  // Constructor
  ReservedSpace(size_t size);
  ReservedSpace(size_t size, size_t forced_base_alignment, bool ism);
