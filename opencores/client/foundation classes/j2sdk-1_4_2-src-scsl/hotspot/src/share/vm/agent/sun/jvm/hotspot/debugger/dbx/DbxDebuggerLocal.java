/*
 * @(#)DbxDebuggerLocal.java	1.28 03/01/23 11:29:19
 *
...
public class DbxDebuggerLocal extends DebuggerBase implements DbxDebugger {
  ...
  public synchronized void attach(int processID) throws DebuggerException {
    try {
      ...
      e.printStackTrace();
      detach();
      throw new DebuggerException("Error while connecting to dbx process");
    }
  }
  ...
  public synchronized String consoleExecuteCommand(String cmd) throws DebuggerException {
    try {
      ...
      e.printStackTrace();
      detach();
      throw new DebuggerException("Error while executing command on dbx console");
    }
  }
