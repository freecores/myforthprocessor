...
#pragma ident "@(#)formssel.hpp	1.57 03/01/23 11:13:18 JVM"
#endif
/*
...
public:
  ...
  virtual bool        is_ideal_branch() const;  // "" 'If' | 'Goto' | 'LoopEnd'
...
public:
  ...
  NameList _instrs;               // Ordered list of instruction names
  Dict     _opers;                // Instruction/Operand List mapping table
