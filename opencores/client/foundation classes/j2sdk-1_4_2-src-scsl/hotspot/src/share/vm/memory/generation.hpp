...
#pragma ident "@(#)generation.hpp	1.160 03/01/23 12:08:44 JVM"
#endif
/*
...
//     - PermGeneration            - reflective object area (klasses, methods, symbols, ...)
...
class Generation: public CHeapObj {
 ...
 public:
  ...
  // will do.
  virtual const bool refs_discovery_is_atomic() const { return true;  }
