...
#pragma ident "@(#)generation.cpp	1.221 03/01/23 12:08:40 JVM"
#endif
/*
...
Generation::Generation(ReservedSpace rs, size_t initial_size, int level) :
  _level(level) {
    ...
    _ref_processor.set_span(_reserved);
}
...
void Generation::ref_processor_init() {
  ref_processor()->initialize(refs_discovery_is_atomic(), // atomic_discovery
