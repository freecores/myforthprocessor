...
#pragma ident "@(#)port.hpp	1.36 03/01/23 12:06:16 JVM"
#endif
/*
...
#if defined(__alpha) || defined(__sparcv9) || defined(__ia64) // Where long > 32 bits
typedef signed int int32;	// Exactly 32bits signed 
typedef unsigned int uint32;	// Exactly 32bits unsigned 
#else				// Most unix boxes
typedef signed long int32;	// Exactly 32bits signed 
typedef unsigned long uint32;	// Exactly 32bits unsigned 
#endif
