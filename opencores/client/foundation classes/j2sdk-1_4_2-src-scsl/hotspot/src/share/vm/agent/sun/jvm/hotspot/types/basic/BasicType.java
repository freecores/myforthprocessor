/*
 * @(#)BasicType.java	1.6 03/01/23 11:48:23
 *
...
public class BasicType implements Type {
  ...
  public Field getField(String fieldName, boolean searchSuperclassFields,
    ...
    if (nameToFieldMap != null) {
      Field field = (Field) nameToFieldMap.get(fieldName);
    ...
    if (searchSuperclassFields) {
      if (superclass != null) {
        return superclass.getField(fieldName, searchSuperclassFields, throwExceptionIfNotFound);
      }
    }
