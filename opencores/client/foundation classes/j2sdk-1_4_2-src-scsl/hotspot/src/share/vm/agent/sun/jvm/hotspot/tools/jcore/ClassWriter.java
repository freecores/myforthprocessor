/*
 * @(#)ClassWriter.java	1.5 03/01/23 11:47:03
 *
...
public class ClassWriter implements /* imports */ ClassConstants
{
    ...
    // Map between any UTF-8 and it's constant pool index.
    ...
    protected void writeConstantPool() throws IOException {
        ...
        // collect all UTF-8 Strings from Constant Pool
        ...
        // remember index of attribute name UTF-8 strings
        ...
        for(ci = 1; ci < len; ci++) {
            ...
            switch(cpConstType) {
                case JVM_CONSTANT_Utf8: {
                     ...
                     if (DEBUG) debugMessage("CP[" + ci + "] = UTF-8 " + sym.asString());
                     break;
                }
