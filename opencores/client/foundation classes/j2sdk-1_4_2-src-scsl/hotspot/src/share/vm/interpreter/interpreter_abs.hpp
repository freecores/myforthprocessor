...
#pragma ident "@(#)interpreter_abs.hpp	1.127 03/01/23 12:05:23 JVM"
#endif
/*
...
class AbstractInterpreter: AllStatic {
 ...
 protected:
  ...
  NOT_PRODUCT(static address    _bci_histogram_entry;)
 ...
 public:
  ...
  NOT_PRODUCT(static address    bci_histogram_entry()           { return _bci_histogram_entry; })
...
class AbstractInterpreterGenerator: public StackObj {
 protected:
  ...
  address generate_bci_histogram_entry()        PRODUCT_RETURN0;
  ...
  void histogram_bci()                          PRODUCT_RETURN;
