# 
# @(#)top.make	1.37 03/01/23 10:50:49
# 
...
# We do not want people accidentally building on Solaris 2.5.1 (uname=5.5.1).
check_os_version:
...
$(GENERATED)/$(MakeDepsClass): $(MakeDepsSources)
	@CLASSPATH=$(GAMMADIR)/src/share/tools/MakeDeps $(MAKEDEPS_JAVAC) -g -d $(GENERATED) $(MakeDepsSources)
