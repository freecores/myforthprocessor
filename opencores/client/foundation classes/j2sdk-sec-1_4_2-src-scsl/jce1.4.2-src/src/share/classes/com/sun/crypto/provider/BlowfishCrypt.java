...
final class BlowfishCrypt extends SymmetricCipher 
	...
	temp[0] = (((int) in[inOffset] & 0x0ff) << 24) |
	    (((int) in[inOffset + 1] & 0x0ff) << 16) |
	    (((int) in[inOffset + 2] & 0x0ff) << 8) |
	    ((int) in[inOffset + 3] & 0x0ff);

	temp[1] = (((int) in[inOffset + 4] & 0x0ff) << 24) |
	    (((int) in[inOffset + 5] & 0x0ff) << 16) |
	    (((int) in[inOffset + 6] & 0x0ff) << 8) |
	    ((int) in[inOffset + 7] & 0x0ff);
	...
	out[outOffset] = (byte) ((temp[0] >> 24) & 0x0ff);
	out[outOffset + 1] = (byte) ((temp[0] >> 16) & 0x0ff);
	out[outOffset + 2] = (byte) ((temp[0] >> 8) & 0x0ff);
	out[outOffset + 3] = (byte) (temp[0] & 0x0ff);

	out[outOffset + 4] = (byte) ((temp[1] >> 24) & 0x0ff);
	out[outOffset + 5] = (byte) ((temp[1] >> 16) & 0x0ff);
	out[outOffset + 6] = (byte) ((temp[1] >> 8) & 0x0ff);
	out[outOffset + 7] = (byte) (temp[1] & 0x0ff);
    }
    ...
    private int F(int value) {
        ...
        d = 0x0ff & value; value >>= 8;        
        c = 0x0ff & value; value >>= 8;        
        b = 0x0ff & value; value >>= 8;        
        a = 0x0ff & value;
    ...
    private final int[][] s = new int[4][256]; // s-boxes
