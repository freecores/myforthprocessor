 ...
 * {@link #getKeySpec(javax.crypto.SecretKey, java.lang.Class) getKeySpec} methods.
...
public class SecretKeyFactory {
    ...
    { 
	try {
	    Object[] objs = JceSecurity.getImpl(algorithm, "SecretKeyFactory",
						(String)null);
	    return new SecretKeyFactory((SecretKeyFactorySpi)objs[0],
