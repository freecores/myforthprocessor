...
public class KeyAgreement {
    ...
    {
	try {
	    Object[] objs = JceSecurity.getImpl(algorithm, "KeyAgreement",
						(String)null);
	    return new KeyAgreement((KeyAgreementSpi)objs[0],
				    (Provider)objs[1],
				    algorithm);
	...
	Object[] objs = JceSecurity.getImpl(algorithm, "KeyAgreement",
					    provider);
	return new KeyAgreement((KeyAgreementSpi)objs[0], (Provider)objs[1],
				algorithm);
    }
    ...
    {
	keyAgreeSpi.engineInit(key, JceSecurity.RANDOM);
    }
    ...
    {
	keyAgreeSpi.engineInit(key, params, JceSecurity.RANDOM);
    }
