 ...
 *
 * @version 1.39, 06/24/03
 * @author David Brownell
 */
final class OutputRecord extends ByteArrayOutputStream implements Record {
     ...
     */
    void encrypt(CipherBox engine) {
	int len = count - headerSize;
	count = headerSize + engine.encrypt(buf, headerSize, len);
    }
