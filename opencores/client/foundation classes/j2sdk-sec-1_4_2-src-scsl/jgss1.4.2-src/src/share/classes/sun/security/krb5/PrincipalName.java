...
/*
 * @(#)PrincipalName.java	1.18 03/06/24
 *
...
public class PrincipalName 
    ...
    // string is fixed
    // TBD: Error checkin consistent with MIT krb5_parse_name?
    // TBD: Code repetition, realm parsed again by class Realm?
    ...
    public static void test(String n) throws RealmException {
	System.out.println("name='" + n + "'");
	PrincipalName pn = new PrincipalName(n);
	String[] s = pn.getNameStrings();
	for (int i = 0; i < s.length; i++)
	    System.out.println("part[" + i + "]='" + s[i] + "'");
	System.out.println("realm='" + pn.getRealmString() + "'");
	System.out.println();
    }
