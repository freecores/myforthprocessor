...
public class Krb5 {
    ...
    public static final boolean KDC_EMPTY_ADDRESSES_ALLOWED = DEFAULT_EMPTY_ADDRESSES_ALLOWED;
	...
	errMsgList.put(new Integer(KRB_ERR_RESPONSE_TOO_BIG), "Response too big for UDP, retry with TCP");
	...
	errMsgList.put(new Integer(KRB_ERR_FIELD_TOOLONG), "Field is too long for this implementation");
        errMsgList.put(new Integer(KRB_AP_ERR_NOREALM), "Realm name not available"); //used in setDefaultCreds() in sun.security.krb5.Credentials
	...
	errMsgList.put(new Integer(KRB_CRYPTO_NOT_SUPPORT), "Client has no support for crypto type");
	errMsgList.put(new Integer(KRB_AP_ERR_REQ_OPTIONS), "Invalid option setting in ticket request.");
        errMsgList.put(new Integer(KRB_AP_ERR_GEN_CRED), "Fail to create credential.");
    }
