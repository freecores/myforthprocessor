...
:LOCAL sort.Object.Object§1827294976
   ...
   CELL+ @ OVER
   OVER ! NIP
   sort.Object§-1890496768.table OVER 12 + !
   -1890516992 OVER 20 + !
   " Object " OVER 16 + ! DROP
   
   \ new statement
   0
   §this CELL+ @ 24 + ( sort.Object._dynamicBlocking )    !
...
:LOCAL sort.Object.clone§-360160512
   LOCAL §this
...
:LOCAL sort.Object.equals§-240098048
   LOCAL obj
   LOCAL §this
...
:LOCAL sort.Object.finalize§997811712
   LOCAL §this
...
:LOCAL sort.Object.hashCode§-1604556800
   LOCAL §this
...
:LOCAL sort.Object.notify§2134994432
   LOCAL §this
...
:LOCAL sort.Object.notifyAll§2130144768
   LOCAL §this
...
:LOCAL sort.Object.toString§1621718016
   LOCAL §this
   ...
   length
   string
   equation.JavaArray.createString§-105880832 DUP TO 0§
   U" @ " COUNT equation.JavaArray.createUnicode§-675323136 DUP TO 1§
   DUP INCREFERENCE  OVER  -1461427456 TRUE ( equation.String.concat§-1461427456 ) EXECUTE-METHOD DUP TO 2§
   §this A:R@
   R> -1604556800 TRUE ( sort.Object.hashCode§-1604556800 ) EXECUTE-METHOD
   <# 0 ..R equation.JavaArray.createString§-105880832  DUP TO 3§
   DUP INCREFERENCE  OVER  -1461427456 TRUE ( equation.String.concat§-1461427456 ) EXECUTE-METHOD
   3§ TRUE equation.JavaArray.kill§1620077312
   2§ TRUE equation.JavaArray.kill§1620077312
   ...
   \ new statement
   h TRUE equation.JavaArray.kill§1620077312
...
:LOCAL sort.Object.wait§-1913293056
   2LOCAL timeout
   LOCAL §this
...
:LOCAL sort.Object.wait§-892045568
   LOCAL §this
   ...
   0
   S>D
   R> -1913293056 TRUE ( sort.Object.wait§-1913293056 ) EXECUTE-METHOD
...
:LOCAL sort.Object.wait§2084337408
   LOCAL nanos
   2LOCAL timeout
   LOCAL §this
   ...
   nanos
   500000
   < INVERT  0=! or_1975 0BRANCH DROP
   nanos
   0<> and_1976 0BRANCH! DROP
   timeout
   D0=
   and_1976 LABEL
   or_1975 LABEL
...
:LOCAL sort.Object.~destructor§-1086882304
   LOCAL §this
   ...
   DROP
;
VARIABLE sort.Object._staticBlocking

A:HERE VARIABLE sort.Object§-1890496768.table 12 DUP 2* CELLS ALLOT R@ ! A:CELL+
1827294976 R@ ! A:CELL+ sort.Object.Object§1827294976 VAL R@ ! A:CELL+
-360160512 R@ ! A:CELL+ sort.Object.clone§-360160512 VAL R@ ! A:CELL+
-240098048 R@ ! A:CELL+ sort.Object.equals§-240098048 VAL R@ ! A:CELL+
997811712 R@ ! A:CELL+ sort.Object.finalize§997811712 VAL R@ ! A:CELL+
-1604556800 R@ ! A:CELL+ sort.Object.hashCode§-1604556800 VAL R@ ! A:CELL+
2134994432 R@ ! A:CELL+ sort.Object.notify§2134994432 VAL R@ ! A:CELL+
2130144768 R@ ! A:CELL+ sort.Object.notifyAll§2130144768 VAL R@ ! A:CELL+
1621718016 R@ ! A:CELL+ sort.Object.toString§1621718016 VAL R@ ! A:CELL+
-1913293056 R@ ! A:CELL+ sort.Object.wait§-1913293056 VAL R@ ! A:CELL+
-892045568 R@ ! A:CELL+ sort.Object.wait§-892045568 VAL R@ ! A:CELL+
2084337408 R@ ! A:CELL+ sort.Object.wait§2084337408 VAL R@ ! A:CELL+
-1086882304 R@ ! A:CELL+ sort.Object.~destructor§-1086882304 VAL R@ ! A:CELL+
A:DROP
