...
public final class Double extends Number implements Comparable {
     ...
     */
    public static final double NEGATIVE_INFINITY = -one / zero;
     ...
     */
    public static final double NaN = zero / zero;
    ...
    public static String toString(double d) {
        int length, bytestring;
        #ass "d F.. TO length TO bytestring";
	return JavaArray.createString(length, bytestring);
    }
    ...
    public static Double valueOf(String s) throws NumberFormatException {
        ...
        int length = b.length;
        int body = ((JavaArray)b).getElem(0);
        double d;
        #ass "body length >FLOAT DROP TO d";
	return new Double(d);
    }
