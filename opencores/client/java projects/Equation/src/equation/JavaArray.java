...
public class JavaArray
 {
  ...
  public Object [] clone()
   {
    ...
    #ass "SWEEP @ 0= IF x DECREFERENCE ENDIF";

    x = array;

    #ass "SWEEP @ 0= IF x INCREFERENCE ENDIF";
  ...
  public void resize(int size)
   {
    ...
    #ass "§this CELL+ @ 20 + @ TO code"; // load code field
    ...
    #ass "x size y LSHIFT RESIZE DROP TO x";
  ...
  public static void kill(Object obj, int polymorph)
   {
    #ass "obj HANDLEVALID";
    #ass "IF obj -1086882304 polymorph EXECUTE-METHOD ENDIF";
   }
