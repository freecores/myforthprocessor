...
:LOCAL Exception.Exception§463815936
   2 VALLOCATE LOCAL §base0
...
:LOCAL Exception.Exception§624903424
...
VARIABLE Exception._staticThread  HERE 4 - SALLOCATE
2VARIABLE Exception.serialVersionUID

A:HERE VARIABLE Exception§-1574681344.table 4 DUP 2* CELLS ALLOT R@ ! A:CELL+
...
463815936 R@ ! A:CELL+ Exception.Exception§463815936 VAL R@ ! A:CELL+
624903424 R@ ! A:CELL+ Exception.Exception§624903424 VAL R@ ! A:CELL+
A:DROP
