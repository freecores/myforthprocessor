...
class Thread implements Runnable {
   ...
   /**
    ...
    public static Thread currentThread()
     {
      return ThreadState.currentThread();
     }
    ...
    public static void sleep(long millis) throws InterruptedException
     {
      ...
      ThreadState.switchTask(ThreadState.RUNNING, null, millis);
     }
	...
	this.priority = (parent != null)? parent.getPriority(): MAX_PRIORITY;
   ...
   /**
	...
	synchronized (this) {
          ...
          ThreadState.switchTask(ThreadState.TERMINATED, this);
	...
	ThreadState.switchTask(ThreadState.SUSPEND, (Object)this, 0);
    }
	...
	ThreadState.unblockTask(ThreadState.SUSPEND, (Object)this, false);
    }
    ...
    public int countStackFrames()
     {
      if (ThreadState.getState(this) != ThreadState.SUSPEND)
       throw new IllegalThreadStateException();
	...
	if (millis == 0) {
		...
		wait(delay);
            #ass "MILLISECONDS 2@ base D- TO now";
	    }
	}
    }
    ...
    *
    ...
    public static boolean holdsLock(Object obj)
     {
      return obj._dynamicThread == null || obj._dynamicThread == currentThread();
     }
}
