...
public class Object {
    ...
    public int _dynamicBlocking = 0;
    public Thread _dynamicThread = null;

    public void monitorEnter(Thread classThread)
     {
      #ass "DI";
      Thread t;

      if (_dynamicThread != null && ThreadState.getState(_dynamicThread) == 0)
       {
        _dynamicThread = null;
        _dynamicBlocking = 0;
       }

      while(((t = Thread.currentThread()) != _dynamicThread || t != classThread && classThread != null) && _dynamicThread != null)
       {
        ThreadState.switchTask(ThreadState.BLOCKED, this, 0);
       }
    ...
    public void monitorLeave()
     {
      #ass "DI";
      if (_dynamicThread == Thread.currentThread() && _dynamicBlocking > 0)
       {
        if (--_dynamicBlocking == 0)
         _dynamicThread = null;
       }
      #ass "EI";
     }
    ...
    {
      #ass "§this ALLOCATED-SIZE A:R@ ALLOCATE DROP A:R>";
      #ass "§this CELL+ @ R@ CELL+ @ R1@ MOVE";
      #ass "SWEEP @ 0= IF";
      #ass "R@ CELL+ @ DUP INCREFERENCE";
      #ass "CELL+ DUP INCREFERENCE";
      #ass "CELL+ INCREFERENCE";
      #ass "ENDIF";
      #ass "R@ A:2DROP";
    }
    ...
    public String toString() {
        String h;
        int string, length;
        #ass "§this CELL+ @ 16 + COUNT TO length TO string";
	return JavaArray.createString(length, string) + "@" + hashCode();
    }
    ...
    public final void notifyAll() throws IllegalMonitorStateException
    {
     ...
     #ass "DI ";
     ThreadState.unblockTask(ThreadState.WAITING, this, true);
     #ass "EI ";
    }
