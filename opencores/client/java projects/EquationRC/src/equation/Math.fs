...
: lang.Math.IEEEremainder§1596082432
   2LOCAL f2
   2LOCAL f1
...
:LOCAL lang.Math.Math§-590525184
   ...
   CELL+ @ OVER
   OVER ! NIP
   lang.Math§-1239069440.table OVER 12 + !
   -1239089152 OVER 20 + !
   " Math " OVER 16 + !
   0 OVER 24 + ! DROP
...
: lang.Math.classMonitorEnter§-433167616
...
: lang.Math.classMonitorLeave§-1691393280
...
: lang.Math.toDegrees§2084860928
   2LOCAL angrad
...
:LOCAL lang.Math.~destructor§-1086882304
   LOCAL §this
   ...
   DROP
;
2VARIABLE lang.Math.E
2VARIABLE lang.Math.PI
VARIABLE lang.Math._staticBlocking
VARIABLE lang.Math._staticThread

A:HERE VARIABLE lang.Math§-1239069440.table 2 DUP 2* CELLS ALLOT R@ ! A:CELL+
-590525184 R@ ! A:CELL+ lang.Math.Math§-590525184 VAL R@ ! A:CELL+
-1086882304 R@ ! A:CELL+ lang.Math.~destructor§-1086882304 VAL R@ ! A:CELL+
A:DROP
